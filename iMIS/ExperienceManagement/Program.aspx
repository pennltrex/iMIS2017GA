...
<%@ Register TagPrefix="asiweb" TagName="Program" Src="~/AsiCommon/Controls/ExperienceManagement/Program.ascx" %>
...
<script runat="server">
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        if (!ChildUserControls.Contains(program))
        {
            AddChildUserControl(program);
        }
        ...
        if (string.IsNullOrEmpty(CancelUrl))
            CancelUrl = "~/iMIS/ExperienceManagement/ProgramList.aspx";
    }
...
<asp:Content runat="server" ContentPlaceHolderID="TemplateBody">
   <asiweb:Program ID="program" runat="server" />
</asp:Content>