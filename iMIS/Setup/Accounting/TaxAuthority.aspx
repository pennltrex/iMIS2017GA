<%@ Page Language="C#" MasterPageFile="~/Templates/MasterPages/Empty.master" Inherits="Asi.Web.UI.Common.Utility.TaxAuthority" Codebehind="TaxAuthority.aspx.cs" %>
    ...
    <telerik:RadAjaxPanel runat="server" LoadingPanelID="LoadingPanel">
        ...
        <asiweb:PanelTemplateControl2 ID="PanelTemplateControl1" runat="server" Collapsible="false" FieldSet="false">
            ...
            <asiweb:Lister2
                ...
                AddTargetUrl="TaxAuthorityDialog.aspx" 
                AjaxEnabled="true" 
                ...
                DataKeyNames="TaxAuthorityId"
                DisplayPropertiesList="TaxAuthorityId,Description" 
                DisplayPropertiesTitleOverride="Code,Name"          
                EditColumnLocation="None"             
                EnableClientSideDelete="false" 
                ExportButtonLocation="None" 
                HideResultsOnInitialLoad="Visible"
                ID="TaxAuthorityGrid"
                OnItemDeleted="TaxAuthorityGridOnItemDeleted" 
                OnNeedDataSource="TaxAuthorityGridOnNeedDataSource" 
                OnItemDataBound="TaxAuthorityGridOnItemDataBound"
