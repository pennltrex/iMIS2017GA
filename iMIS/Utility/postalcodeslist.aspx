<%@ Page language="c#" Inherits="Asi.WebRoot.iMIS.Utility.PostalCodesList" Codebehind="PostalCodesList.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="List" Src="~/AsiCommon/Controls/Shared/Utility/PostalCodesList.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<!-- #Include virtual="~/AsiCommon/Includes/Page_OnInit.inc" -->
<HTML>
	<HEAD>
		<title><% Response.Write(Asi.ResourceManager.GetPhrase("PostalCodesList","Postal Codes List")); %></title>
