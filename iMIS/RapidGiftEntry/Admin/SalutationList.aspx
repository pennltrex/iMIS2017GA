<%@ Page Title="Salutation List" Language="C#" AutoEventWireup="true" Inherits="Asi.WebRoot.iMIS.RapidGiftEntry.Admin.SalutationList" Codebehind="SalutationList.aspx.cs" %>
...
<asp:Content id="MainContent" runat="server" ContentPlaceHolderID="TemplateBody">
	...
	<asiweb:BusinessDataGrid SkinID="StandardGrid" id="FindResults" AutoGenerateColumns="False" AllowPaging="false" runat="server" Width="98%" OnItemDataBound="FindResults_OnItemDataBound">
		<Columns>
		    <asp:HyperLinkColumn DataTextField="Key" HeaderText="Salutation Code" DataNavigateUrlField="Key" DataNavigateUrlFormatString="javascript:(function (window) {{ window.Argument = ['PopupReturn','{0}']; window.close(); }})(GetRadWindow());"
				SortExpression="Key" />	
