<%@ Control Language="C#"  ClassName="SimpleWithHtmlTCTAtomPanel" Inherits="Asi.Web.UI.AtomPanelBase" %>
...
{
	get{ return new Guid("dcb5805b-71b6-404e-abde-ef9d522f32a5"); }
}
...
<asp:Panel runat="server" visible="false" id="Panel_NoData">No Data Available</asp:Panel><table>
    <tbody>
        ...
        <tr>
            <td style="width: 20px;"></td>
            <td><asiweb:businesslabel boundpropertyname="ContentHtml" runat="server" displayvalue="true">[Html]</asiweb:businesslabel> </td>
        </tr>
    </tbody>
</table>
<br /><asp:PlaceHolder id="PlaceHolder_editlink" runat="server"></asp:PlaceHolder>