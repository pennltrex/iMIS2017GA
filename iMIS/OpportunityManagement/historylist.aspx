<%@ Page language="C#" Inherits="Asi.Web.UI.DisplayPageBase" Title="History" %>
<%@ Register TagPrefix="uc2" TagName="TaskButtons" Src="~/AsiCommon/Controls/OpportunityManagement/TaskButtons.ascx" %>
<%@ Register TagPrefix="uc1" TagName="HistoryList" Src="~/AsiCommon/Controls/OpportunityManagement/HistoryList.ascx" %>
			    ...
			    <table style="width:100%; height:100%;" cellspacing="0" cellpadding="0" border="0">
		            ...
		            <tr>
			            <td class="WorkSpace" style="height:100%; vertical-align:top;">
			                <div id="content">
				                <uc1:HistoryList id="HistoryList1" runat="server"/>
				            </div>
			            </td>
		            </tr>
                </table>
