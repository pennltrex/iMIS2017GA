...
<%@ Register TagPrefix="uc1" TagName="GroupsList" Src="~/AsiCommon/Controls/OpportunityManagement/GroupsList.ascx" %>
			    ...
			    <table style="width:100%; height:100%;" cellspacing="0" cellpadding="0" border="0">
		            ...
		            <tr>
			            <td class="WorkSpace" style="height:100%; vertical-align:top;">
			                <div id="content">
				                <uc1:GroupsList id="GroupsList1" runat="server"></uc1:GroupsList>
				            </div>
			            </td>
		            </tr>
                </table>
