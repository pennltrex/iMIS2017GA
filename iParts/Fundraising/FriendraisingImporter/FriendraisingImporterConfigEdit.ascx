<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FriendraisingImporterConfigEdit.ascx.cs" Inherits="Asi.Web.iParts.Fundraising.FriendraisingImporter.FriendraisingImporterConfigEdit" %>
...
<asiweb:paneltemplatecontrol ID="ContainerPanel" runat="server" FieldSet="true" ShowHeader="false" BorderStyle="None">
    ...
    <div class="AutoWidth">
        ...
        <asiweb:SmartControl 
            ID="DownloadButtonText" runat="server" 
            BoundPropertyName="DownloadButtonText" DisplayCaption="true" 
