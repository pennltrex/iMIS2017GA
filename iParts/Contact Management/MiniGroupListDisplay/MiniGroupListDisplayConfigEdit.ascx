<%@ Control Language="C#" ClassName="Asi.Web.iParts.ContactManagement.MiniGroupListDisplay.MiniGroupListDisplayCommon" Inherits="Asi.Web.UI.ContentItemEditBase" %>
<script runat="server"> 
    public override string AtomComponentName
    {
        get
        {
            return "Mini Group List Display";
        }
    }
</script>
