<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FunctionDisplayConfigEdit.ascx.cs" Inherits="Asi.Web.iParts.Events.FunctionDisplayConfigEdit" %>
...
<asiweb:paneltemplatecontrol ID="ContainerPanel" runat="server" FieldSet="true" ShowHeader="false" BorderStyle="None">
    ...
    <asiweb:SmartControl ID="ImageWidth" runat="server" BoundPropertyName="ImageWidth" DisplayCaption="true" PositionCaption="Left" />
