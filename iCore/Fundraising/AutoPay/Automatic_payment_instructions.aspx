...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("b719e186-2452-425b-89a5-c27866a75a07"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("e22384ef-07c0-48e0-8178-881d8e6d72e9"); } }
	...
	<div class="row">
		<div class="col-sm-12">
				...
				<asp:WebPartZone ID="WebPartZone1_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:QueryMenu ID="ciAutomaticPaymentInstructions" runat="server" ContentKey="b719e186-2452-425b-89a5-c27866a75a07" ContentItemKey="73e5b796-0b73-4303-8b92-ce4e6f492d1c" Title="AutomaticPaymentInstructions" ShowTitleFlag="False" PartTitle="Automatic payment enrollments" DoNotRenderInDesignMode="False" CssClass="" ShowBorder="False" Collapsible="False" Collapsed="False" DisplayOnExtraSmallScreens="True" DisplayOnSmallScreens="True" DisplayOnMediumScreens="True" DisplayOnLargeScreens="True" ModuleSpecificSetting="" LicenseKeyRestriction="" EnableExport="True" MapResults="False" ListPageSize="20" PagerMode="Advanced" MenuCaptionText="Select a query" UsePopup="False" DisplayForAuthorizedUsersOnly="False" SourceFolderPathControl="$/Fundraising/DefaultSystem/Queries/AutoPay/Automatic payment enrollments" SourceKey="777a1c59-4980-41af-8979-d73e55c1419b" ReloadRefresh="True" EnableEmailMerge="True" AutoRun="True" />
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
