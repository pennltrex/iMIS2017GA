...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("547433b0-5eba-42a7-8936-5d6339b64e99"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("fbdb8335-ffd0-4c67-8083-937478493826"); } }
	...
	protected override void EnsureChildUserControls()
	{
		...
		childUserControl = ciTotalengagedcontacts as Asi.Web.UI.IUserControl;
		if (childUserControl != null)
			AddChildUserControl(childUserControl);
		key = new System.Guid("d0b7014b-802c-4497-b721-65a9d10d9146");
		if(!ContentItemKeyMap.ContainsKey(key))
			ContentItemKeyMap.Add(key, ciTotalengagedcontacts);
        ...
        <div class="col-md-3 col-sm-6">
			<CM:ContentPage ID="ContentPage2" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone2_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone StaffDashboard">
					<ZoneTemplate>
				<CM:ProgressTracker ID="ciTotalengagedcontacts" runat="server" ContentKey="547433b0-5eba-42a7-8936-5d6339b64e99" ContentItemKey="d0b7014b-802c-4497-b721-65a9d10d9146" Title="Total engaged contacts" ShowTitleFlag="False" PartTitle="Total engaged contacts" DoNotRenderInDesignMode="False" CssClass="ProgressTracker_Dashboard_Overview AltBgColor2" ShowBorder="True" Collapsible="False" Collapsed="False" DisplayOnExtraSmallScreens="True" DisplayOnSmallScreens="True" DisplayOnMediumScreens="True" DisplayOnLargeScreens="True" ModuleSpecificSetting="" LicenseKeyRestriction="" ProgressDescription="" QueryStringParameterName="" ListSourceQuery="$/Samples/Dashboards/Engagement/Progress Tracker - Engaged contacts" DataColumnName="(None)" DisplayGoalPercent="False" GoalPercentDescription="" DisplayGoalCountTotal="True" GoalCountTotalDescription="" DisplayGoalDaysRemaining="False" GoalDaysRemainingDescription="" ProgressBarLocation="" SuccessfulMessage="" />
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
        </div>
        <div class="col-md-3 col-sm-6">
			<CM:ContentPage ID="ContentPage3" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone3_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone StaffDashboard">
					<ZoneTemplate>
				<CM:ProgressTracker ID="ciRecentlyengaged" runat="server" ContentKey="547433b0-5eba-42a7-8936-5d6339b64e99" ContentItemKey="af5976c1-c987-4bfd-bd5b-1e3b6eb11748" Title="Recently engaged" ShowTitleFlag="False" PartTitle="Recently engaged" DoNotRenderInDesignMode="False" CssClass="ProgressTracker_Dashboard_Overview AltBgColor3" ShowBorder="True" Collapsible="False" Collapsed="False" DisplayOnExtraSmallScreens="True" DisplayOnSmallScreens="True" DisplayOnMediumScreens="True" DisplayOnLargeScreens="True" ModuleSpecificSetting="" LicenseKeyRestriction="" ProgressDescription="Contacts engaged in the past 6 months" QueryStringParameterName="" ListSourceQuery="$/Samples/Dashboards/Engagement/Progress Tracker - Engaged past 6 months" DataColumnName="(None)" DisplayGoalPercent="False" GoalPercentDescription="" DisplayGoalCountTotal="True" GoalCountTotalDescription="" DisplayGoalDaysRemaining="False" GoalDaysRemainingDescription="" ProgressBarLocation="" SuccessfulMessage="" />
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
        </div>
        ...
        <div class="col-md-3 col-sm-6">
			<CM:ContentPage ID="ContentPage4" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone4_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone StaffDashboard">
					<ZoneTemplate>
				<CM:ProgressTracker ID="ciNewlyengaged" runat="server" ContentKey="547433b0-5eba-42a7-8936-5d6339b64e99" ContentItemKey="5bdf8248-e71e-4b18-acf9-e2a1ca379450" Title="Newly engaged" ShowTitleFlag="False" PartTitle="Newly engaged" DoNotRenderInDesignMode="False" CssClass="ProgressTracker_Dashboard_Overview AltBgColor4" ShowBorder="True" Collapsible="False" Collapsed="False" DisplayOnExtraSmallScreens="True" DisplayOnSmallScreens="True" DisplayOnMediumScreens="True" DisplayOnLargeScreens="True" ModuleSpecificSetting="" LicenseKeyRestriction="" ProgressDescription="Newly engaged contacts this month" QueryStringParameterName="" ListSourceQuery="$/Samples/Dashboards/Engagement/Progress Tracker - Newly engaged this month" DataColumnName="(None)" DisplayGoalPercent="False" GoalPercentDescription="" DisplayGoalCountTotal="True" GoalCountTotalDescription="" DisplayGoalDaysRemaining="False" GoalDaysRemainingDescription="" ProgressBarLocation="" SuccessfulMessage="" />
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
        </div>
...
3
0
5f2f1456-365b-4350-a71f-a596a6cee21c
Top contacts
0
0
1
