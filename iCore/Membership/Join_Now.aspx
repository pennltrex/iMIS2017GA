<%@ Page Language="C#" MasterPageFile="~/Templates/MasterPages/Empty.master" AutoEventWireup="true" Inherits="Asi.Web.UI.ContentRecordPage" Title="Join Now" %>
...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("cb6c4b08-dd2a-49ef-83fc-b537db3535fb"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("9cc1b07b-fa30-49f1-b3eb-b7da7471ecc2"); } }
	...
	protected override void EnsureChildUserControls()
	{
		...
		childUserControl = ciProceedToCheckoutButton as Asi.Web.UI.IUserControl;
		if (childUserControl != null)
			AddChildUserControl(childUserControl);
		key = new System.Guid("aa188e84-6dd9-4322-9799-8e42314235dc");
		if(!ContentItemKeyMap.ContainsKey(key))
			ContentItemKeyMap.Add(key, ciProceedToCheckoutButton);
