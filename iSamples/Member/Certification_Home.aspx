...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("84669c23-4fd7-443a-9b15-d5180d66f71a"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("176ea60d-c4be-4df6-a9c8-a5bb520d898b"); } }
    ...
    <div class="col-sm-12">
			<CM:ContentPage ID="ContentPage1" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone1_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciTitle_776ca00219a142b9a614d9f12a576408" runat="server" ContentKey="84669c23-4fd7-443a-9b15-d5180d66f71a" ContentItemKey="776ca002-19a1-42b9-a614-d9f12a576408" Title="Title" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_Title" runat="server"><h1> Certification Programs</h1></asp:Panel></CM:ContentHtml>
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
    </div>
    ...
    <div class="col-sm-6">
			<CM:ContentPage ID="ContentPage2" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone2_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciSpotlight1_72b1c3c063eb47f9b996402842876354" runat="server" ContentKey="84669c23-4fd7-443a-9b15-d5180d66f71a" ContentItemKey="72b1c3c0-63eb-47f9-b996-402842876354" Title="Spotlight1" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_Spotlight1" runat="server"><div class="Spotlight ContentBlockPrimary">
    ...
    <div class="col-sm-6">
			<CM:ContentPage ID="ContentPage3" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone3_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciSpotlight2_7047a8de61184240a524a40180b3495a" runat="server" ContentKey="84669c23-4fd7-443a-9b15-d5180d66f71a" ContentItemKey="7047a8de-6118-4240-a524-a40180b3495a" Title="Spotlight2" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_Spotlight2" runat="server"><div class="Spotlight ContentBlockPrimary">
    ...
    <div class="col-sm-12">
			<CM:ContentPage ID="ContentPage4" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone4_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciInstructions_410bc4bda5b24cfc8fb287283b888a76" runat="server" ContentKey="84669c23-4fd7-443a-9b15-d5180d66f71a" ContentItemKey="410bc4bd-a5b2-4cfc-8fb2-87283b888a76" Title="Instructions" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_Instructions" runat="server"><h2>Enroll in a program</h2>
