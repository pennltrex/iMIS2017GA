...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("544de5c9-25e0-470c-850e-6a15317ff9a2"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("70a91984-0009-48e5-a54e-0c06b78d5ca2"); } }
	...
	protected override void EnsureChildUserControls()
	{
		...
		childUserControl = ciNewYouTubeVideoCommon as Asi.Web.UI.IUserControl;
		if (childUserControl != null)
			AddChildUserControl(childUserControl);
		key = new System.Guid("090ec373-4445-4a93-a103-7e980e7e2b1a");
		if(!ContentItemKeyMap.ContainsKey(key))
			ContentItemKeyMap.Add(key, ciNewYouTubeVideoCommon);

		childUserControl = ciViewTranscript as Asi.Web.UI.IUserControl;
		if (childUserControl != null)
			AddChildUserControl(childUserControl);
		key = new System.Guid("d53da8fc-93e8-4f4c-8b20-728def1434dc");
		if(!ContentItemKeyMap.ContainsKey(key))
			ContentItemKeyMap.Add(key, ciViewTranscript);
	...
	<div class="row">
		<div class="col-sm-12">
				...
				<asp:WebPartZone ID="WebPartZone1_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:SocialShare ID="ciAboutUsSocialShare" runat="server" ContentKey="544de5c9-25e0-470c-850e-6a15317ff9a2" ContentItemKey="3bb8f439-b51c-4a37-a13f-89ae53080bf7" Title="About Us Social Share" ShowTitleFlag="False" PartTitle="" DoNotRenderInDesignMode="False" CssClass="" ShowBorder="False" Collapsible="False" Collapsed="False" DisplayOnExtraSmallScreens="True" DisplayOnSmallScreens="True" DisplayOnMediumScreens="True" DisplayOnLargeScreens="True" ModuleSpecificSetting="" LicenseKeyRestriction="" BorderVisible="False" UrlToShare="" IconDimension="16" LegendText="Share this page" />
				<CM:ContentHtml ID="ciOurOrganization_37b4b506815247dda0f827932e46db7c" runat="server" ContentKey="544de5c9-25e0-470c-850e-6a15317ff9a2" ContentItemKey="37b4b506-8152-47dd-a0f8-27932e46db7c" Title="Our Organization" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_OurOrganization" runat="server"><div class="ClearFix">
...
<a href="<%= ((Asi.Web.UI.DisplayPageBase)Page).iMISWebsite.WebsiteBaseUrl + "/" %>iSamples/member/Benefits.aspx" class="btn PrimaryButton LargeButton" style="float: right;">Become a member</a>
</div>
</div>
	...
	<div class="row">
		...
		<div class="col-sm-4">
				...
				<asp:WebPartZone ID="WebPartZone4_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:YouTubeVideo ID="ciNewYouTubeVideoCommon" runat="server" ContentKey="544de5c9-25e0-470c-850e-6a15317ff9a2" ContentItemKey="090ec373-4445-4a93-a103-7e980e7e2b1a" Title="New YouTubeVideoCommon" ShowTitleFlag="False" PageTitle="" DoNotRenderInDesignMode="False" ShowBorder="False" YouTubeUrl="http://www.youtube.com/watch?v=XXWgoVDx1II" AutoPlay="False" HideControls="True" Width="275" Height="225" />
				<CM:BigButtonPanel ID="ciViewTranscript" runat="server" ContentKey="544de5c9-25e0-470c-850e-6a15317ff9a2" ContentItemKey="d53da8fc-93e8-4f4c-8b20-728def1434dc" Title="ViewTranscript" ShowTitleFlag="False" PartTitle="" DoNotRenderInDesignMode="False" CssClass="" ShowBorder="False" Collapsible="False" Collapsed="False" DisplayOnExtraSmallScreens="True" DisplayOnSmallScreens="True" DisplayOnMediumScreens="True" DisplayOnLargeScreens="True" ModuleSpecificSetting="" LicenseKeyRestriction="" ImageUrl="" NavigationIdentifier="" ChildLevelsToDisplay="0" ExistingLegacyBorder="ExistingLegacyBorder" ActionMode="Navigation" UsePopup="False" AltText="" IncludeParentLevelItem="False" DisplayForAuthorizedUsersOnly="False" Links="&quot;@/iSamples/Member/Video_Transcript|View transcript&quot;" />
				<CM:ContentHtml ID="ciAdvocacy_761524a097e341f5949faa742d2b02ba" runat="server" ContentKey="544de5c9-25e0-470c-850e-6a15317ff9a2" ContentItemKey="761524a0-97e3-41f5-949f-aa742d2b02ba" Title="Advocacy" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_Advocacy" runat="server"><div class="PanelHead Distinguish">
