...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("fbe97193-4452-4a60-bfe7-2b2c97d3068d"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("2a87f52d-e3ea-4910-8a1e-76a1032388af"); } }
    ...
    <div class="col-sm-12">
			<CM:ContentPage ID="ContentPage1" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone1_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:SocialShare ID="ciNewSocialShareCommon" runat="server" ContentKey="fbe97193-4452-4a60-bfe7-2b2c97d3068d" ContentItemKey="8c2b2406-7e14-4920-b94f-24f84d88095e" Title="New SocialShareCommon" ShowTitleFlag="False" PartTitle="" DoNotRenderInDesignMode="False" CssClass="" ShowBorder="False" Collapsible="False" Collapsed="False" DisplayOnExtraSmallScreens="True" DisplayOnSmallScreens="True" DisplayOnMediumScreens="True" DisplayOnLargeScreens="True" ModuleSpecificSetting="" LicenseKeyRestriction="" BorderVisible="False" UrlToShare="" IconDimension="16" LegendText="Share this page" />
				<CM:ContentHtml ID="ciHeader_bec727a1963a466b9d433cd0682da586" runat="server" ContentKey="fbe97193-4452-4a60-bfe7-2b2c97d3068d" ContentItemKey="bec727a1-963a-466b-9d43-3cd0682da586" Title="Header" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_Header" runat="server"><h1 class="BigHeader">Association News</h1></asp:Panel></CM:ContentHtml>
				<CM:ContentHtml ID="ciConferencepicture_1cc2bc87c24a4597b1574849d73a2a65" runat="server" ContentKey="fbe97193-4452-4a60-bfe7-2b2c97d3068d" ContentItemKey="1cc2bc87-c24a-4597-b157-4849d73a2a65" Title="Conference picture" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_Conferencepicture" runat="server"><img alt="Business Feature" src="<%= Asi.Business.ContentManagement.NavigationHierarchy.GetTildeExpansion().TrimEnd('/') + "/" %>images/SampleSites/member/businessfeature.gif" class="FloatLeft" style="max-width: 100%; padding-right: 1em;" />
    ...
    <div class="col-sm-6">
			<CM:ContentPage ID="ContentPage2" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone2_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciNewContentHtml2_86623d8a4d6d480fabefa90e19faaf38" runat="server" ContentKey="fbe97193-4452-4a60-bfe7-2b2c97d3068d" ContentItemKey="86623d8a-4d6d-480f-abef-a90e19faaf38" Title="New ContentHtml_2" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_NewContentHtml2" runat="server"><h2>Job Openings</h2>
    ...
    <div class="col-sm-6">
			<CM:ContentPage ID="ContentPage3" runat="server" PageNumber="1">
				<asp:WebPartZone ID="WebPartZone3_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciNewContentHtml_e83d447e8d1b4ce6a8b6a12963fc551b" runat="server" ContentKey="fbe97193-4452-4a60-bfe7-2b2c97d3068d" ContentItemKey="e83d447e-8d1b-4ce6-a8b6-a12963fc551b" Title="New ContentHtml" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_NewContentHtml" runat="server"><h2>Member Spotlight</h2>
