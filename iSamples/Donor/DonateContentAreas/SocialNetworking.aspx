...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("526fc75a-38c7-407c-b533-6096af196008"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("61dd8404-1292-41af-8c0d-84eee9f8a98b"); } }
	...
	<div class="row">
		<div class="col-sm-12">
				...
				<asp:WebPartZone ID="WebPartZone1_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciSocialNetworking_3681253baff9498a96d16a17398617c9" runat="server" ContentKey="526fc75a-38c7-407c-b533-6096af196008" ContentItemKey="3681253b-aff9-498a-96d1-6a17398617c9" Title="Social Networking" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_SocialNetworking" runat="server"></asp:Panel></CM:ContentHtml>
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
