...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("250950aa-3993-44f8-b28b-b79594fecb04"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("1f8e4e50-49c9-4391-a479-9beeb702776f"); } }
	...
	<div class="row">
		<div class="col-sm-12">
				...
				<asp:WebPartZone ID="WebPartZone1_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciFooterCopyright_22dcba3774264435bdcebf7a73f2e432" runat="server" ContentKey="250950aa-3993-44f8-b28b-b79594fecb04" ContentItemKey="22dcba37-7426-4435-bdce-bf7a73f2e432" Title="Footer Copyright" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_FooterCopyright" runat="server"><div class="row footer-social-copyright">
