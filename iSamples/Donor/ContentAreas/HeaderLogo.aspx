...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("9417f4c0-df7e-4a8c-95b0-c96238531d79"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("137e4e64-4450-4f70-bc01-0d513c6ace6a"); } }
	...
	<div class="row">
		<div class="col-sm-12">
				...
				<asp:WebPartZone ID="WebPartZone1_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciHeaderLogoSpan_0eb07afe9bd944898fa71f2e34cc0938" runat="server" ContentKey="9417f4c0-df7e-4a8c-95b0-c96238531d79" ContentItemKey="0eb07afe-9bd9-4489-8fa7-1f2e34cc0938" Title="Header Logo Span" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_HeaderLogoSpan" runat="server"><a href="<%= ((Asi.Web.UI.DisplayPageBase)Page).iMISWebsite.WebsiteBaseUrl + "/" %>" id="masterDonorHeaderImage" title="Home">iMIS</a></asp:Panel></CM:ContentHtml>
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
