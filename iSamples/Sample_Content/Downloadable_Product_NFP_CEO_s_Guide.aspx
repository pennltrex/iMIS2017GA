<%@ Page Language="C#" MasterPageFile="~/Templates/MasterPages/Empty.master" AutoEventWireup="true" Inherits="Asi.Web.UI.ContentRecordPage" Title="Downloadable Product: NFP CEO's Guide" %>
...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("9a2f0288-2b0a-40e1-ad11-0d770f7c971a"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("4e483fc6-ae48-40ba-8668-90e0cb4b5c55"); } }
	...
	protected override void EnsureChildUserControls()
	{
		...
		childUserControl = ciNotforprofitCEOGuide as Asi.Web.UI.IUserControl;
		if (childUserControl != null)
			AddChildUserControl(childUserControl);
		key = new System.Guid("56639068-e1fa-4d07-b2de-06e4934978a1");
		if(!ContentItemKeyMap.ContainsKey(key))
			ContentItemKeyMap.Add(key, ciNotforprofitCEOGuide);
...
(516) 987-2222 </span></asp:Panel></CM:ContentHtml>
				<CM:ContentHtml ID="ciCongratulationsonyourpurchase_c5e0c6a3da3a44e7b2a3dbb42e00d446" runat="server" ContentKey="9a2f0288-2b0a-40e1-ad11-0d770f7c971a" ContentItemKey="c5e0c6a3-da3a-44e7-b2a3-dbb42e00d446" Title="Congratulations on your purchase!" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_Congratulationsonyourpurchase" runat="server"><span style="font-size: 18px; color: #0070c0;">Thank you for purchasing <em>The Not-for-Profit CEO's Guide to Improving Organizational Performance: How to make sure your business strategy drives your technology investments</em>. We offer you this book as a practical resource. Use it wisely and the rewards will be great!<br />
<br />
	...
	<div class="row">
		<div class="col-sm-6">
				...
				<asp:WebPartZone ID="WebPartZone2_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentFile ID="ciNotforprofitCEOGuide" runat="server" ContentKey="9a2f0288-2b0a-40e1-ad11-0d770f7c971a" ContentItemKey="56639068-e1fa-4d07-b2de-06e4934978a1" Title="Not-for-profit CEO Guide" ShowTitleFlag="False" FileTypeCode="PDF" FileName="Not-for-profit CEO Guide" FileDescription="" FileDocumentStorageKey="b1116410-ba9e-44a3-9762-4dd72ccfe556" />
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
