...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("1953b3b6-8413-421b-a258-df6da1293659"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("dd8fdc5f-73be-4788-86b6-091779c04b72"); } }
	...
	<div class="row">
		<div class="col-sm-12">
				...
				<asp:WebPartZone ID="WebPartZone1_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciFooterCopyright_22dcba3774264435bdcebf7a73f2e432" runat="server" ContentKey="1953b3b6-8413-421b-a258-df6da1293659" ContentItemKey="22dcba37-7426-4435-bdce-bf7a73f2e432" Title="Footer Copyright" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_FooterCopyright" runat="server"><span>© 2017 Washington State Medical Association</span></asp:Panel></CM:ContentHtml>
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
