...
<script language="C#" runat="server">
	...
	override public Guid ContentRecordKey { get { return new Guid("4e1ceac6-78ae-468e-a164-39c94690bf28"); } }

	override public Guid ContentHierarchyKey { get { return new Guid("209ca8d4-f355-40f5-bcb5-05f7700c32d9"); } }
	...
	<div class="row">
		<div class="col-sm-12">
				...
				<asp:WebPartZone ID="WebPartZone1_Page1" runat="server" PartChromeType="None" WebPartVerbRenderMode="TitleBar" CssClass="WebPartZone ">
					<ZoneTemplate>
				<CM:ContentHtml ID="ciHeaderLogoSpan_0eb07afe9bd944898fa71f2e34cc0938" runat="server" ContentKey="4e1ceac6-78ae-468e-a164-39c94690bf28" ContentItemKey="0eb07afe-9bd9-4489-8fa7-1f2e34cc0938" Title="Header Logo Span" ShowTitleFlag="False" ShowBorder="False"><asp:Panel ID="Panel_HeaderLogoSpan" runat="server"><a href="<%= ((Asi.Web.UI.DisplayPageBase)Page).iMISWebsite.WebsiteBaseUrl + "/" %>Default.aspx" id="masterHeaderImage" title="Home">WSMA</a></asp:Panel></CM:ContentHtml>
					</ZoneTemplate>
				</asp:WebPartZone>
			</CM:ContentPage>
