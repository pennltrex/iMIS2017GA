...
YAHOO.Tools.makeChildren=function(arr,elm){var tmp=$(elm);if(tmp != null)var elm=tmp;for(var i in arr){_val=arr[i];if(typeof _val=='string'){_val=this.makeTxtObject(_val);}
