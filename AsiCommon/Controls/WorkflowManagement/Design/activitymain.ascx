...
<%@ Control Language="c#" Inherits="Asi.Web.UI.Common.WorkflowManagement.Design.ActivityMain" Codebehind="ActivityMain.ascx.cs" %>
<div align=left>
...
<iewc:TabStrip id="SubSectionTabStrip" runat="server" width="100%" autopostback="true" font-size="10pt"
	...
	<iewc:Tab Text="xAssignments"></iewc:Tab>
	<iewc:TabSeparator></iewc:TabSeparator>
	<iewc:Tab Text="xImplementation"></iewc:Tab>
	<iewc:TabSeparator></iewc:TabSeparator>
	<iewc:Tab Text="xTransitions"></iewc:Tab>
