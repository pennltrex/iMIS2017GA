<%@ Control Language="c#" Inherits="Asi.Web.UI.Common.WorkflowManagement.Design.TransitionMain" Codebehind="TransitionMain.ascx.cs" %>
...
<iewc:TabStrip id="SubSectionTabStrip" runat="server" width="100%" autopostback="true" font-size="10pt"
	...
	TabHoverStyle="color:black;text-decoration:none;">
	<iewc:Tab Text="xDetail"></iewc:Tab>
	<iewc:TabSeparator></iewc:TabSeparator>
	<iewc:Tab Text="xConditions"></iewc:Tab>
