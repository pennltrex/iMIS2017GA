<%@ Page language="c#"%>
<%@ Register TagPrefix="uc1" TagName="EmailPreview" Src="EmailPreview.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<!-- #Include virtual="~/AsiCommon/Includes/Page_OnInit.inc" -->
<html>
	<head>
	<title>
	<% Response.Write(Asi.ResourceManager.GetPhrase("EmailPreview","Email Preview")); %>
	</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="EmailPreview" method="post" runat="server">
			<uc1:EmailPreview id="EmailPreview1" runat="server"></uc1:EmailPreview>
		</form>
	</body>
</html>
