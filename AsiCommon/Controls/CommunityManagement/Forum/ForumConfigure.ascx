<%@ Control Language="C#" AutoEventWireup="true" Inherits="AsiCommon_Controls_CommunityManagement_Forum_ForumConfigure" Codebehind="ForumConfigure.ascx.cs" %>
...
<asiweb:PanelTemplateControl2 ID="mainPanel" runat="server" Collapsible="false" FieldSet="true" BorderStyle="None">
        ...
        <div class="AutoWidth">
            ...
            <asiweb:SmartControl runat="server" AtomComponentName="CommunityDocument" BoundPropertyName="CommunityAreaModerationRequired" ID="ModeratedForumControl" Visible="false" DisplayType="EditableField" DisplayCaption="true" PositionCaption="Right" />
        </div>    
