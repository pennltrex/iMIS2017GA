<%@ Control Language="c#" Inherits="Asi.Web.UI.Common.CampaignManagement.MemberExportAtomDesignerSummary" Codebehind="MemberExportAtomDesignerSummary.ascx.cs" %>
	...
	<tr>
		...
		<td class="PanelTableValue">
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					<td><asp:textbox id="txtName" runat="server" MaxLength="50" ontextchanged="StatusChanged"></asp:textbox></td>
					<td align="left"></td>
				</tr>
			</table>
		</td>
