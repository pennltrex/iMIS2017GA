...
<html>
  <head>
	<title>
	<% Response.Write(Asi.ResourceManager.GetPhrase("ReportingServicesParamCollector","ReportingServices Parameter Collector")); %>
	</title>
 ...
 <!-- #Include virtual="~/AsiCommon/Includes/Document_Head_Script.inc" -->
  ...
  <body MS_POSITIONING="GridLayout">
    ...
    <form id="ReportingServicesParamCollector" method="post" runat="server">
