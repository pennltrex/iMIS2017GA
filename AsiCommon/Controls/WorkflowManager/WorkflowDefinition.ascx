...
<%@ Control Language="c#" AutoEventWireup="false" Inherits="Asi.Web.UI.Common.WorkflowManager.WorkflowDefinition" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" Codebehind="WorkflowDefinition.ascx.cs" %>
...
<table class=DataTable style="TABLE-LAYOUT: fixed" cellspacing=1 cellpadding=3 align=center border=0>
  ...
  <tr>
    ...
    <td class="PanelTableValue"><asiweb:SmartControl id="scComment" runat="server"></asiweb:SmartControl></td>
    </tr>
    </asp:panel>
    </TABLE>
