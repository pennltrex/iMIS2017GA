<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AccountArea.ascx.cs" Inherits="Asi.WebAppRoot.AsiCommon.Controls.Staff.AccountArea" %>
<%@ Register TagPrefix="asi" TagName="OBOPanel" Src="~/AsiCommon/Controls/Shared/Security/ContactProxyPanel.ascx" %>

<ul runat="server" ID="AccountMenu" class="account-menu" translate="yes"> <%-- note that the CSS class changes in the code behind when OBO is available --%>
    ...
    <li runat="server" id="ProfileMenu" class="dropdown" Visible="False">
        <a href="#" class="dropdown-toggle account-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
            ...
            <asp:Label runat="server" ID="PartyName" CssClass="nav-text" translate="no"/>
