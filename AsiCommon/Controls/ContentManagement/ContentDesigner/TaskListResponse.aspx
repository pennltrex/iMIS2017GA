<%@ Page Language="C#" AutoEventWireup="true" Inherits="AsiCommon_Controls_ContentManagement_ContentDesigner_TaskListResponse" MasterPageFile="~/Templates/MasterPages/empty.master" Codebehind="TaskListResponse.aspx.cs" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="TemplateBody">
    <asiweb:PanelTemplateControl ID="TaskListResponsePanel" runat="server" FieldSet="true" ShowHeader="true" TemplateTitle="Send a Message" BorderStyle="None">
