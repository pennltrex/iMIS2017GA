<%@ Control Language="C#" Inherits="AsiCommon_Controls_ContentManagement_ContentDesigner_TaskList" Codebehind="TaskList.ascx.cs" %>
...
<asiweb:PanelTemplateControl2 ID="WorkingPanel" runat="server" TemplateTitle="Content you are working on" Collapsed="False" FieldSet="true">
...
<asiweb:PanelTemplateControl2 ID="AwaitingApprovalPanel" runat="server" TemplateTitle="Content awaiting approval" Collapsed="false">
    <div class="ButtonPanel" ID="ApproveButtonPanel" runat="server">
        <asiweb:StyledButton ID="ApproveSelected" runat="server" Text="Approve Selected" OnClick="ApproveSelected_Click" translate="yes"/>
        <asiweb:StyledButton ID="ApprRespondSelected" runat="server" Text="Return Selected" OnClick="ApprRespondSelected_Click" translate="yes"/>
    </div>
...
<asiweb:PanelTemplateControl2 ID="DeletionRequestsPanel" runat="server" TemplateTitle="Content deletion requests" Collapsed="false">
    <div class="ButtonPanel" id="DeleteButtonPanel" runat="server">
        <asiweb:StyledButton ID="DeleteSelected" runat="server" Text="Delete Selected" OnClick="DeleteSelected_Click" translate="yes"/>
        <asiweb:StyledButton ID="DelRespondSelected" runat="server" Text="Respond to Selected" OnClick="DelRespondSelected_Click" translate="yes" />
        <asiweb:StyledButton ID="DelRemoveSelected" runat="server" Text="Remove from List" OnClick="DelRemoveSelected_Click" translate="yes"/>
    </div>
...
<asiweb:PanelTemplateControl2 ID="ExpiringPanel" runat="server" TemplateTitle="Content that has expired or will soon expire" Collapsed="false">
