<%@ Control Language="C#" Inherits="AsiCommon_Controls_ContentManagement_ContentDesigner_ContentRecordTagManagement" Codebehind="ContentRecordTagManagement.ascx.cs" %>
