...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'IndividualExternalNetwork' AND [CONSTRAINT_NAME] = 'FK_IndividualExternalNetwork_ExternalNetwork')
    ALTER TABLE [dbo].[IndividualExternalNetwork] WITH CHECK ADD CONSTRAINT [FK_IndividualExternalNetwork_ExternalNetwork]
    FOREIGN KEY (ExternalNetworkId) REFERENCES [ExternalNetwork] (ExternalNetworkId)
go
ALTER TABLE [dbo].[IndividualExternalNetwork] CHECK CONSTRAINT [FK_IndividualExternalNetwork_ExternalNetwork]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'IndividualExternalNetwork' AND [CONSTRAINT_NAME] = 'FK_IndividualExternalNetwork_Name')
    ALTER TABLE [dbo].[IndividualExternalNetwork] WITH CHECK ADD CONSTRAINT [FK_IndividualExternalNetwork_Name]
    FOREIGN KEY (ID) REFERENCES [Name] (ID)
go
ALTER TABLE [dbo].[IndividualExternalNetwork] CHECK CONSTRAINT [FK_IndividualExternalNetwork_Name]
go
