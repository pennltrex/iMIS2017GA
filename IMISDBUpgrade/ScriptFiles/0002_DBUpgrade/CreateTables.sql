...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[ExternalNetwork]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[ExternalNetwork] (
    [ExternalNetworkId] uniqueidentifier NOT NULL CONSTRAINT [DF_ExternalNetwork_NetworkId] DEFAULT (newid()),
    [Name] nvarchar(50) NOT NULL,
...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[IndividualExternalNetwork]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[IndividualExternalNetwork] (
    [IndividualExternalNetworkId] uniqueidentifier NOT NULL CONSTRAINT [DF_IndividualExternalNetwork_PartyExternalNetworkId] DEFAULT (newid()),
    [ExternalNetworkId] uniqueidentifier NOT NULL,
    [ID] varchar(10) NOT NULL,
