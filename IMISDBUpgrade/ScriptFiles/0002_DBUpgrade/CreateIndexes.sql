...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CertificationProgramRegistration]') AND [name] = N'IX_CertificationProgramRegistration_UserKey')
BEGIN
  CREATE NONCLUSTERED INDEX IX_CertificationProgramRegistration_UserKey ON [dbo].[CertificationProgramRegistration] (UserKey)
END
go
...
BEGIN
  CREATE NONCLUSTERED INDEX IX_ContactMain_IsInstitute ON [dbo].[ContactMain] (IsInstitute) INCLUDE (ID, SyncContactID, ContactKey)
END
go
...
CREATE NONCLUSTERED INDEX IX_ContactMain_IsInstitute_ContactTypeKey ON [dbo].[ContactMain] ([IsInstitute] ASC, [ContactTypeKey] ASC) INCLUDE ( [ContactKey], [ID], [SyncContactId]) 
GO
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CustomerExperience]') AND [name] = N'IX_CustomerExperience_UserKey')
BEGIN
  CREATE NONCLUSTERED INDEX IX_CustomerExperience_UserKey ON [dbo].[CustomerExperience] (UserKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CustomerExperienceStatusChange]') AND [name] = N'IX_CustomerExperienceStatusChange_StatusChangedUserKey')
BEGIN
  CREATE NONCLUSTERED INDEX IX_CustomerExperienceStatusChange_StatusChangedUserKey ON [dbo].[CustomerExperienceStatusChange] (StatusChangedUserKey)
END
go
...
BEGIN
  CREATE NONCLUSTERED INDEX IX_DocumentMain_StatusKey_VersionKey_Key_Name_Typecode ON [dbo].[DocumentMain] (DocumentStatusCode, DocumentVersionKey, DocumentKey, DocumentName, DocumentTypeCode) INCLUDE (RelatedDocumentVersionKey)
END
go
...
BEGIN
  CREATE NONCLUSTERED INDEX IX_DocumentMain_DocumentVersionKey_DocumentStatusCode_UpdatedOn ON [dbo].[DocumentMain] (DocumentVersionKey, DocumentStatusCode, UpdatedOn) INCLUDE (DocumentTypeCode, DocumentKey)
END
go
...
BEGIN
  CREATE NONCLUSTERED INDEX IX_DocumentMain_DocumentVersionKey_CreatedOn_AccessKey ON [dbo].[DocumentMain] (DocumentVersionKey, CreatedOn, AccessKey) INCLUDE (DocumentKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[ExternalNetwork]') AND [name] = N'PK_ExternalNetwork')
BEGIN
  ALTER TABLE [dbo].[ExternalNetwork]
  ADD CONSTRAINT PK_ExternalNetwork PRIMARY KEY CLUSTERED (ExternalNetworkId)
END
go
...
BEGIN
  CREATE NONCLUSTERED INDEX IX_Hierarchy_ParentHierarchyKey_HierarchyKey_UniformKey ON [dbo].[Hierarchy] (ParentHierarchyKey, HierarchyKey, UniformKey) INCLUDE (Depth, SortOrder, UniformType, RootHierarchyKey, HierarchyCode, IsChildAMemberOfParent)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[IndividualExternalNetwork]') AND [name] = N'PK_IndividualExternalNetwork')
BEGIN
  ALTER TABLE [dbo].[IndividualExternalNetwork]
  ADD CONSTRAINT PK_IndividualExternalNetwork PRIMARY KEY CLUSTERED (IndividualExternalNetworkId)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[IndividualExternalNetwork]') AND [name] = N'IX_IndividualExternalNetwork_ID')
BEGIN
  CREATE NONCLUSTERED INDEX IX_IndividualExternalNetwork_ID ON [dbo].[IndividualExternalNetwork] (ID)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[IndividualExternalNetwork]') AND [name] = N'IX_IndividualExternalNetwork_ExternalNetworkId')
BEGIN
  CREATE NONCLUSTERED INDEX IX_IndividualExternalNetwork_ExternalNetworkId ON [dbo].[IndividualExternalNetwork] (ExternalNetworkId)
END
go
...
BEGIN
  CREATE NONCLUSTERED INDEX iInvoice_BTID ON [dbo].[Invoice] (BT_ID) INCLUDE (INVOICE_NUM, ORIGINATING_TRANS_NUM, REFERENCE_NUM)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[RegistrationStatusChange]') AND [name] = N'IX_RegistrationStatusChange_StatusChangedUserKey')
BEGIN
  CREATE NONCLUSTERED INDEX IX_RegistrationStatusChange_StatusChangedUserKey ON [dbo].[RegistrationStatusChange] (StatusChangedUserKey)
END
go
...
BEGIN
  CREATE NONCLUSTERED INDEX IX_SystemConfig_ParameterName_OrganizationKey_SystemConfigKey ON [dbo].[SystemConfig] (ParameterName, OrganizationKey, SystemConfigKey) INCLUDE (ParameterValue)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[SystemConfig]') AND [name] = N'IX_ParameterName')
BEGIN
  CREATE NONCLUSTERED INDEX IX_ParameterName ON [dbo].[SystemConfig] (ParameterName)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[SystemConfigParameterRef]') AND [name] = N'IX_PARAMETERNAME')
BEGIN
  CREATE NONCLUSTERED INDEX IX_PARAMETERNAME ON [dbo].[SystemConfigParameterRef] (ParameterName)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Trans]') AND [name] = N'iTans_IS_FR_ITEM')
BEGIN
  CREATE NONCLUSTERED INDEX iTans_IS_FR_ITEM ON [dbo].[Trans] (IS_FR_ITEM) INCLUDE (INVOICE_REFERENCE_NUM)
END
go
...
BEGIN
  CREATE NONCLUSTERED INDEX IX_UserMain_UserId ON [dbo].[UserMain] (UserId) INCLUDE (ProviderKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[vSoaInvoiceSummaryCashBase]') AND [name] = N'PK_vSoaInvoiceSummaryCashBase')
BEGIN
  CREATE UNIQUE CLUSTERED INDEX PK_vSoaInvoiceSummaryCashBase ON [dbo].[vSoaInvoiceSummaryCashBase] (InvoiceId)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[vSoaInvoiceSummaryCashBase]') AND [name] = N'IX_vSoaInvoiceSummaryCashBase_SoldToPartyId')
BEGIN
  CREATE NONCLUSTERED INDEX IX_vSoaInvoiceSummaryCashBase_SoldToPartyId ON [dbo].[vSoaInvoiceSummaryCashBase] (SoldToPartyId)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[vSoaInvoiceSummaryCashBase]') AND [name] = N'IX_vSoaInvoiceSummaryCashBase_InvoiceNumber')
BEGIN
  CREATE NONCLUSTERED INDEX IX_vSoaInvoiceSummaryCashBase_InvoiceNumber ON [dbo].[vSoaInvoiceSummaryCashBase] (InvoiceNumber)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[vSoaInvoiceSummaryCashBase]') AND [name] = N'IX_vSoaInvoiceSummaryCashBase_BillToPartyId')
BEGIN
  CREATE NONCLUSTERED INDEX IX_vSoaInvoiceSummaryCashBase_BillToPartyId ON [dbo].[vSoaInvoiceSummaryCashBase] (BillToPartyId)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[vSoaInvoiceSummaryInvoice]') AND [name] = N'PK_vSoaInvoiceSummaryInvoice')
BEGIN
  CREATE UNIQUE CLUSTERED INDEX PK_vSoaInvoiceSummaryInvoice ON [dbo].[vSoaInvoiceSummaryInvoice] (InvoiceId)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[vSoaInvoiceSummaryInvoice]') AND [name] = N'IX_vSoaInvoiceSummaryInvoice_SoldToPartyId')
BEGIN
  CREATE NONCLUSTERED INDEX IX_vSoaInvoiceSummaryInvoice_SoldToPartyId ON [dbo].[vSoaInvoiceSummaryInvoice] (SoldToPartyId)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[vSoaInvoiceSummaryInvoice]') AND [name] = N'IX_vSoaInvoiceSummaryInvoice_InvoiceNumber')
BEGIN
  CREATE NONCLUSTERED INDEX IX_vSoaInvoiceSummaryInvoice_InvoiceNumber ON [dbo].[vSoaInvoiceSummaryInvoice] (InvoiceNumber)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[vSoaInvoiceSummaryInvoice]') AND [name] = N'IX_vSoaInvoiceSummaryInvoice_BillToPartyId')
BEGIN
  CREATE NONCLUSTERED INDEX IX_vSoaInvoiceSummaryInvoice_BillToPartyId ON [dbo].[vSoaInvoiceSummaryInvoice] (BillToPartyId)
END
go
