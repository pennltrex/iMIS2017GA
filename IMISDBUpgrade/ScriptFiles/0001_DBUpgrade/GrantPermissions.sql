...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Background')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Background] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Communication')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Communication] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Education')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Education] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Informz_Mailings')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Informz_Mailings] TO [IMIS]
go

IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Informz_Surveys')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Informz_Surveys] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Name_CEU')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Name_CEU] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Name_FRProfile')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Name_FRProfile] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Name_JoinOnline')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Name_JoinOnline] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Name_Lookup')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Name_Lookup] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Name_TabTest')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Name_TabTest] TO [IMIS]
go

IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Name_Volunteer')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Name_Volunteer] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Organization_Demo')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Organization_Demo] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'P ' and name = 'sp_asi_UpdateFundraisingViewTables')
    GRANT EXECUTE ON [sp_asi_UpdateFundraisingViewTables] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'Survey')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [Survey] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'TransWatch')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [TransWatch] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'V ' and name = 'vDonorClubReport')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [vDonorClubReport] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'V ' and name = 'vGivingHistory')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [vGivingHistory] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'V ' and name = 'vSoftCreditHistory')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [vSoftCreditHistory] TO [IMIS]
go
