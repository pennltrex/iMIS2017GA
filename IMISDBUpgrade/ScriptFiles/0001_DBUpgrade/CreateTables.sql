...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[Background]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Background] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Background_ID] DEFAULT (''),
    [SEQN] int NOT NULL CONSTRAINT [DF_Background_SEQN] DEFAULT (0),
    [StartYear] int NOT NULL CONSTRAINT [DF_Background_StartYear] DEFAULT (0),
    [EndYear] int NOT NULL CONSTRAINT [DF_Background_EndYear] DEFAULT (0),
    [JobTitle] varchar(30) NOT NULL CONSTRAINT [DF_Background_JobTitle] DEFAULT (''),
    [Responsibilities] varchar(100) NOT NULL CONSTRAINT [DF_Background_Responsibilities] DEFAULT (''),
    [Manager] varchar(15) NOT NULL CONSTRAINT [DF_Background_Manager] DEFAULT (''),
    [EducationLevel] varchar(15) NOT NULL CONSTRAINT [DF_Background_EducationLevel] DEFAULT (''),
    [CManager] bit NOT NULL CONSTRAINT [DF_Background_CManager] DEFAULT (0),
    [TIME_STAMP] timestamp NULL
)
...
CREATE TABLE [dbo].[Batch] (
    ...
    [INTENT_TO_EDIT] varchar(30) NOT NULL CONSTRAINT [DF_Batch_INTENT_TO_EDIT] DEFAULT (''),
...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[Communication]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Communication] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Communication_ID] DEFAULT (''),
    [NewsLetter] bit NOT NULL CONSTRAINT [DF_Communication_NewsLetter] DEFAULT (0),
    [Phone] bit NOT NULL CONSTRAINT [DF_Communication_Phone] DEFAULT (0),
    [Email] bit NOT NULL CONSTRAINT [DF_Communication_Email] DEFAULT (0),
    [Phone1] varchar(15) NOT NULL CONSTRAINT [DF_Communication_Phone1] DEFAULT (''),
    [Email1] varchar(60) NOT NULL CONSTRAINT [DF_Communication_Email1] DEFAULT (''),
    [NewsType] varchar(30) NOT NULL CONSTRAINT [DF_Communication_NewsType] DEFAULT (''),
    [TIME_STAMP] timestamp NULL
)
...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[Education]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Education] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Education_ID] DEFAULT (''),
    [Undergraduate] varchar(20) NOT NULL CONSTRAINT [DF_Education_Undergraduate] DEFAULT (''),
    [Graduate] varchar(20) NOT NULL CONSTRAINT [DF_Education_Graduate] DEFAULT (''),
    [Professional] varchar(20) NOT NULL CONSTRAINT [DF_Education_Professional] DEFAULT (''),
    [Other] varchar(20) NOT NULL CONSTRAINT [DF_Education_Other] DEFAULT (''),
    [UndergradeDate] datetime NULL,
...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[Informz_Mailings]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Informz_Mailings] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Informz_Mailings_ID] DEFAULT (''),
    [SEQN] int NOT NULL CONSTRAINT [DF_Informz_Mailings_SEQN] DEFAULT (0),
    [Mailing_ID] float NOT NULL CONSTRAINT [DF_Informz_Mailings_Mailing_ID] DEFAULT (0),
    [Mailing_Name] varchar(30) NOT NULL CONSTRAINT [DF_Informz_Mailings_Mailing_Name] DEFAULT (''),
    [Publish_Date] datetime NULL,
    [Clicked] varchar(30) NOT NULL CONSTRAINT [DF_Informz_Mailings_Clicked] DEFAULT (''),
    [Delivered] varchar(30) NOT NULL CONSTRAINT [DF_Informz_Mailings_Delivered] DEFAULT (''),
    [Opened] varchar(30) NOT NULL CONSTRAINT [DF_Informz_Mailings_Opened] DEFAULT (''),
    [TIME_STAMP] timestamp NULL
)
...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[Informz_Surveys]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Informz_Surveys] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Informz_Surveys_ID] DEFAULT (''),
    [SEQN] int NOT NULL CONSTRAINT [DF_Informz_Surveys_SEQN] DEFAULT (0),
    [Survey_ID] float NOT NULL CONSTRAINT [DF_Informz_Surveys_Survey_ID] DEFAULT (0),
    [Survey_Name] varchar(30) NOT NULL CONSTRAINT [DF_Informz_Surveys_Survey_Name] DEFAULT (''),
    [Date_Started_Survey] datetime NULL,
    [Date_Completed] datetime NULL,
    [Completed] bit NOT NULL CONSTRAINT [DF_Informz_Surveys_Completed] DEFAULT (0),
    [Value_1] varchar(30) NOT NULL CONSTRAINT [DF_Informz_Surveys_Value_1] DEFAULT (''),
    [Value_2] varchar(30) NOT NULL CONSTRAINT [DF_Informz_Surveys_Value_2] DEFAULT (''),
    [Value_3] varchar(30) NOT NULL CONSTRAINT [DF_Informz_Surveys_Value_3] DEFAULT (''),
    [TIME_STAMP] timestamp NULL
)
...
CREATE TABLE [dbo].[Name] (
    ...
    [INTENT_TO_EDIT] varchar(30) NOT NULL CONSTRAINT [DF_Name_INTENT_TO_EDIT] DEFAULT (''),
...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[Name_CEU]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Name_CEU] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Name_CEU_ID] DEFAULT (''),
    [SEQN] int NOT NULL CONSTRAINT [DF_Name_CEU_SEQN] DEFAULT (0),
    [CEU_Year] varchar(4) NOT NULL CONSTRAINT [DF_Name_CEU_CEU_Year] DEFAULT (''),
    [CEU_Course] varchar(30) NOT NULL CONSTRAINT [DF_Name_CEU_CEU_Course] DEFAULT (''),
    [CEU_Event] varchar(30) NOT NULL CONSTRAINT [DF_Name_CEU_CEU_Event] DEFAULT (''),
    [CEU_Followup] varchar(30) NOT NULL CONSTRAINT [DF_Name_CEU_CEU_Followup] DEFAULT (''),
    [CEU_Hours] float NOT NULL CONSTRAINT [DF_Name_CEU_CEU_Hours] DEFAULT (0),
    [CEU_Notes] varchar(200) NOT NULL CONSTRAINT [DF_Name_CEU_CEU_Notes] DEFAULT (''),
    [CEU_Source] varchar(30) NOT NULL CONSTRAINT [DF_Name_CEU_CEU_Source] DEFAULT (''),
    [CEU_Type] varchar(30) NOT NULL CONSTRAINT [DF_Name_CEU_CEU_Type] DEFAULT (''),
    [CEU_Date_Reported] datetime NULL,
    [TIME_STAMP] timestamp NULL
)
...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[Name_FRProfile]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Name_FRProfile] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Name_FRProfile_ID] DEFAULT (''),
    [Anniversary] datetime NULL,
    [Christmas_Appeal] bit NOT NULL CONSTRAINT [DF_Name_FRProfile_Christmas_Appeal] DEFAULT (0),
    [Deliv_Pref] varchar(15) NOT NULL CONSTRAINT [DF_Name_FRProfile_Deliv_Pref] DEFAULT (''),
    [Education_Level] varchar(25) NOT NULL CONSTRAINT [DF_Name_FRProfile_Education_Level] DEFAULT (''),
    [FR_12MoAmt] money NOT NULL CONSTRAINT [DF_Name_FRProfile_FR_12MoAmt] DEFAULT (0),
    [FR_1YearAgoAmt] money NOT NULL CONSTRAINT [DF_Name_FRProfile_FR_1YearAgoAmt] DEFAULT (0),
    [FR_24MoAmt] money NOT NULL CONSTRAINT [DF_Name_FRProfile_FR_24MoAmt] DEFAULT (0),
    [FR_2YearAgoAmt] money NOT NULL CONSTRAINT [DF_Name_FRProfile_FR_2YearAgoAmt] DEFAULT (0),
    [FR_36MoAmt] money NOT NULL CONSTRAINT [DF_Name_FRProfile_FR_36MoAmt] DEFAULT (0),
    [FR_3MoAmt] money NOT NULL CONSTRAINT [DF_Name_FRProfile_FR_3MoAmt] DEFAULT (0),
    [TIME_STAMP] timestamp NULL
)
...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[Name_JoinOnline]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Name_JoinOnline] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Name_JoinOnline_ID] DEFAULT (''),
    [ChapterCode] varchar(15) NOT NULL CONSTRAINT [DF_Name_JoinOnline_ChapterCode] DEFAULT (''),
    [Join1] bit NOT NULL CONSTRAINT [DF_Name_JoinOnline_Join1] DEFAULT (0),
    [Join2] bit NOT NULL CONSTRAINT [DF_Name_JoinOnline_Join2] DEFAULT (0),
    [Join3] bit NOT NULL CONSTRAINT [DF_Name_JoinOnline_Join3] DEFAULT (0),
    [Sub1] bit NOT NULL CONSTRAINT [DF_Name_JoinOnline_Sub1] DEFAULT (0),
    [Sub2] bit NOT NULL CONSTRAINT [DF_Name_JoinOnline_Sub2] DEFAULT (0),
    [TIME_STAMP] timestamp NULL
)
...
IF NOT EXISTS (SELECT * FROM [dbo].[sysobjects] WHERE [id] = OBJECT_ID(N'[dbo].[Organization_Demo]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Organization_Demo] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Organization_Demo_ID] DEFAULT (''),
    [Staff_Size] float NOT NULL CONSTRAINT [DF_Organization_Demo_Staff_Size] DEFAULT (0),
    [Annual_Revenue] float NOT NULL CONSTRAINT [DF_Organization_Demo_Annual_Revenue] DEFAULT (0),
    [Date_Founded] datetime NULL,
    [Web_Site] varchar(100) NOT NULL CONSTRAINT [DF_Organization_Demo_Web_Site] DEFAULT (''),
    [TIME_STAMP] timestamp NULL
)
...
CREATE TABLE [dbo].[Rpt_BadgeTbl] (
    ...
    [REG_TYPE] varchar(20) NOT NULL CONSTRAINT [DF_Rpt_BadgeTbl_REG_TYPE] DEFAULT (''),
...
CREATE TABLE [dbo].[Subscriptions] (
    ...
    [INTENT_TO_EDIT] varchar(30) NOT NULL CONSTRAINT [DF_Subscriptions_INTENT_TO_EDIT] DEFAULT (''),
...
CREATE TABLE [dbo].[Survey] (
    [ID] varchar(10) NOT NULL CONSTRAINT [DF_Survey_ID] DEFAULT (''),
    [SEQN] int NOT NULL CONSTRAINT [DF_Survey_SEQN] DEFAULT (0),
    [Year] datetime NULL,
    [Age] int NOT NULL CONSTRAINT [DF_Survey_Age] DEFAULT (0),
    [Employed] varchar(6) NOT NULL CONSTRAINT [DF_Survey_Employed] DEFAULT (''),
    [HomeOwned] varchar(4) NOT NULL CONSTRAINT [DF_Survey_HomeOwned] DEFAULT (''),
    [NumChildren] int NOT NULL CONSTRAINT [DF_Survey_NumChildren] DEFAULT (0),
    [EdLevel] varchar(15) NOT NULL CONSTRAINT [DF_Survey_EdLevel] DEFAULT (''),
    [NumAuto] int NOT NULL CONSTRAINT [DF_Survey_NumAuto] DEFAULT (0),
    [PBirth] varchar(50) NOT NULL CONSTRAINT [DF_Survey_PBirth] DEFAULT (''),
    [DOB] datetime NULL,
    [eMail] varchar(60) NOT NULL CONSTRAINT [DF_Survey_eMail] DEFAULT (''),
    [YMember] int NOT NULL CONSTRAINT [DF_Survey_YMember] DEFAULT (0),
    [StateChap] varchar(6) NOT NULL CONSTRAINT [DF_Survey_StateChap] DEFAULT (''),
    [MType] varchar(30) NOT NULL CONSTRAINT [DF_Survey_MType] DEFAULT (''),
    [AIncome] int NOT NULL CONSTRAINT [DF_Survey_AIncome] DEFAULT (0),
