...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[AccessItem]') AND [name] = N'IX_AccessItem_GroupKey')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[AccessMain]') AND [name] = N'IX_AccessMain_AccessScope')
BEGIN
...
BEGIN
  ...
  INCLUDE (SOLICITOR_ID, PRODUCT_CODE, ORIGINATING_TRANS_NUM, TAXABLE_VALUE, ORG_CODE, EFFECTIVE_DATE, CAMPAIGN_CODE, AMOUNT, SOURCE_CODE, SOURCE_SYSTEM, TRANSACTION_DATE, ACTION_CODES, UF_4)
END
go
...
BEGIN
  ...
  INCLUDE (SOURCE_CODE, ID, ORG_CODE, CAMPAIGN_CODE)
END
go
...
BEGIN
  ...
  INCLUDE (ID, EFFECTIVE_DATE, SEQN, THRU_DATE, ACTION_CODES)
END
go
...
BEGIN
  ...
  INCLUDE (PRODUCT_CODE, SOLICITOR_ID, ID, ORG_CODE, EFFECTIVE_DATE, CAMPAIGN_CODE, ACTIVITY_TYPE, MEM_TRIB_CODE, AMOUNT, ACTION_CODES, UF_4, TRANSACTION_DATE, TAXABLE_VALUE, SOURCE_SYSTEM, SOURCE_CODE)
END
go
...
BEGIN
  ...
  INCLUDE (ORIGINATING_TRANS_NUM, SEQN, ACTIVITY_TYPE, TRANSACTION_DATE)
END
go
...
BEGIN
  ...
  INCLUDE (ID, ORG_CODE, STATUS_CODE, PRODUCT_CODE, ORIGINATING_TRANS_NUM, RECURRING_REQUEST, CAMPAIGN_CODE, EFFECTIVE_DATE, AMOUNT, UF_2, TRANSACTION_DATE, ACTION_CODES, SEQN, SOURCE_CODE, THRU_DATE)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Activity]') AND [name] = N'iActivityACTION_CODES')
BEGIN
  CREATE NONCLUSTERED INDEX iActivityACTION_CODES ON [dbo].[Activity] (ACTION_CODES)
  INCLUDE (THRU_DATE, EFFECTIVE_DATE, ACTIVITY_TYPE, PRODUCT_CODE, ID)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[AuthorizationProvider]') AND [name] = N'PK_AuthorizationProviders')
BEGIN
...
BEGIN
  ...
  INCLUDE (IntervalTypeCode, ProductCode, CustomerId, StartDate, AuthorizedPaymentAmount, InstructionId)
END
go
...
BEGIN
  ...
  INCLUDE (CustomerId, IntervalTypeCode, InstructionId, StartDate, EndDate)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLog]') AND [name] = N'PK_CommunicationLog')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogEvent]') AND [name] = N'PK_CommunicationLogEvent')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogEvent]') AND [name] = N'IX_CommunicationLogEvent_CommunicationLogRecipientKey')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogEventTypeRef]') AND [name] = N'PK_CommunicationLogEventTypeRef')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogRecipient]') AND [name] = N'PK_CommunicationLogRecipient')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogRecipient]') AND [name] = N'IX_CommunicationLogRecipient_ContactKey')
BEGIN
  CREATE NONCLUSTERED INDEX IX_CommunicationLogRecipient_ContactKey ON [dbo].[CommunicationLogRecipient] (ContactKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogRecipient]') AND [name] = N'IX_CommunicationLogRecipient_CommunicationLogKey')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogRecipient]') AND [name] = N'IX_CommunicationLogRecipient_Address_MessageId')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogRecipientAttachment]') AND [name] = N'PK_CommunicationLogRecipientAttachment')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogRecipientAttachment]') AND [name] = N'IX_CommunicationLogRecipientAttachment_CommunicationLogRecipientKey')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationLogStatusRef]') AND [name] = N'PK_CommunicationLogStatusRef')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationMessageTypeRef]') AND [name] = N'PK_CommunicationMessageTypeRef')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CommunicationReasonRef]') AND [name] = N'IX_CommunicationReasonRef_Name')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[ContactMain]') AND [name] = N'IX_ContactMain_IsInstitute_ContactTypeKey')
BEGIN
...
BEGIN
  ...
  INCLUDE (ID, AccessKey, SyncContactID, ContactKey)
END
go
...
BEGIN
  ...
  INCLUDE (DocumentVersionKey, DocumentKey, DocumentName, DocumentStatusCode)
END
go
...
BEGIN
  ...
  INCLUDE (DocumentVersionKey, AccessKey, UpdatedOn, AlternateName, DocumentName, DocumentKey)
END
go
...
BEGIN
  ...
  INCLUDE (DocumentName, DocumentKey, AccessKey, UpdatedOn, DocumentVersionKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[DocumentMain]') AND [name] = N'IX_DocumentMain_AccessKey')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Duplicate]') AND [name] = N'iDuplicateSEQN')
BEGIN
  CREATE NONCLUSTERED INDEX iDuplicateSEQN ON [dbo].[Duplicate] (SEQN)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Duplicate_Group]') AND [name] = N'iDuplicate_GroupSEQN')
BEGIN
...
BEGIN
  ...
  INCLUDE (Amount, TransactionDate, OriginalTransaction, FiscalYear, ID, DateReceived, FiscalMonth)
END
go
...
BEGIN
  ...
  INCLUDE (InvoiceReferenceNumber, ID, IsMatchingGift, ListAs, MatchingTransaction, MemorialID, SolicitorID, TransactionDate, PaymentType, RequestNumber, MemorialNameText, OriginalTransaction, Amount, FiscalMonth, AppealCode, CampaignCode, CheckNumber, FiscalYear, DateReceived, Fund)
END
go
...
BEGIN
  ...
  INCLUDE (InvoiceReferenceNumber, Amount, Fund)
END
go
...
BEGIN
  ...
  INCLUDE (JoinDate, DropDate, GroupKey, IsActive)
END
go
...
BEGIN
  ...
  INCLUDE (MemberContactKey, GroupMemberKey)
END
go
...
BEGIN
  ...
  INCLUDE (HierarchyKey, HierarchyCode, ParentHierarchyKey, IsChildAMemberOfParent, UniformType, UniformKey)
END
go
...
BEGIN
  ...
  INCLUDE (RootHierarchyKey, IsChildAMemberOfParent, MarkedForDeleteOn, HierarchyCode, Depth, SortOrder, UniformType)
END
go
...
BEGIN
  ...
  INCLUDE (UniformKey, RootHierarchyKey, ParentHierarchyKey)
END
go
...
BEGIN
  ...
  INCLUDE (BT_ID, REFERENCE_NUM, ORIGINATING_TRANS_NUM, INVOICE_DATE, INVOICE_NUM, DISCOUNT_DATE, DUE_DATE, EFFECTIVE_DATE, INSTALL_BILL_DATE)
END
go
...
BEGIN
  ...
  INCLUDE (INVOICE_NUM, REFERENCE_NUM, DUE_DATE)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[LocalizationVersion]') AND [name] = N'IX_LocalizationVersion_LocalizationVersionId')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Name]') AND [name] = N'iNameSTATUSMT')
BEGIN
...
BEGIN
  ...
  INCLUDE (COUNTRY, FULL_NAME, JOIN_DATE, ID, MEMBER_TYPE, CO_ID)
END
go
...
BEGIN
  ...
  INCLUDE (FULL_NAME, PAID_THRU, ID, JOIN_DATE, STATUS)
END
go
...
BEGIN
  ...
  INCLUDE (LAST_FIRST, FULL_NAME, EMAIL, COMPANY_SORT, COMPANY, COMPANY_RECORD, MEMBER_TYPE, PREVIOUS_MT, MT_CHANGE_DATE, ORG_CODE)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Name_Indexes]') AND [name] = N'iName_IndexesINDEX_VALUE')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[NotificationSet]') AND [name] = N'PK_NotificationSet')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[NotificationSet]') AND [name] = N'IX_NotificationSet_NotificationSetName')
BEGIN
  CREATE NONCLUSTERED INDEX IX_NotificationSet_NotificationSetName ON [dbo].[NotificationSet] (NotificationSetName)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[NotificationSetDetail]') AND [name] = N'PK_NotificationSetDetail')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[NotificationSetDetail]') AND [name] = N'IX_NotificationSetDetail_NotificationSetKey')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[ObjectPropertyMetaData]') AND [name] = N'PK_ObjectPropertyMetaData')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Order_Badge]') AND [name] = N'iOrder_BadgeFULL_NAME')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Order_Lines]') AND [name] = N'iOrder_LinesORDER_NUMBER')
BEGIN
  CREATE NONCLUSTERED INDEX iOrder_LinesORDER_NUMBER ON [dbo].[Order_Lines] (ORDER_NUMBER)
  INCLUDE (ADDED_TO_WAIT_LIST, QUANTITY_ORDERED, PRODUCT_CODE)
END
go
...
BEGIN
  ...
  INCLUDE (ORDER_DATE, ORDER_NUMBER, ST_ID)
END
go
...
BEGIN
  ...
  INCLUDE (TOTAL_CHARGES, BT_ID, BALANCE, SOURCE_SYSTEM, ORDER_DATE)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Orders]') AND [name] = N'iOrdersSOURCE_SYSTEM')
BEGIN
  CREATE NONCLUSTERED INDEX iOrdersSOURCE_SYSTEM ON [dbo].[Orders] (SOURCE_SYSTEM)
  INCLUDE (ORDER_NUMBER, ORDER_DATE, BATCH_NUM)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Orders]') AND [name] = N'iOrdersORDER_NUMBER')
BEGIN
  CREATE NONCLUSTERED INDEX iOrdersORDER_NUMBER ON [dbo].[Orders] (ORDER_NUMBER)
  INCLUDE (BT_ID, STATUS, TITLE, COMPANY, LAST_FIRST, FULL_NAME)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PartyMergeSchemaReference]') AND [name] = N'PK_PartyMergeSchemaReference')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PartyMergeSchemaReference]') AND [name] = N'IX_PartyMergeSchemaReference')
BEGIN
  CREATE NONCLUSTERED INDEX IX_PartyMergeSchemaReference ON [dbo].[PartyMergeSchemaReference] (ProcessingOrder)
  INCLUDE (ProcessingType, TableName, ColumnName)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Product_Tax]') AND [name] = N'IX_Product_Tax_TAXCATEGORY_CODE_COUNTRY')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PublishQueue]') AND [name] = N'IX_PublishQueue_Status')
BEGIN
  CREATE NONCLUSTERED INDEX IX_PublishQueue_Status ON [dbo].[PublishQueue] (Status)
  INCLUDE (PublishServerCode)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PublishQueue]') AND [name] = N'IX_PublishQueue_PublishServerCode')
BEGIN
  CREATE NONCLUSTERED INDEX IX_PublishQueue_PublishServerCode ON [dbo].[PublishQueue] (PublishServerCode)
  INCLUDE (Status)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Subscriptions]') AND [name] = N'iSubscriptionsBALANCE')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[TaskDefinition]') AND [name] = N'PK_TaskDefinition')
BEGIN
...
BEGIN
  ...
  INCLUDE (TRANS_NUMBER, TRANSACTION_DATE, ST_ID, SOURCE_SYSTEM, SOLICITOR_ID, SOURCE_CODE, PRODUCT_CODE, OWNER_ORG_CODE, IS_FR_ITEM, INVOICE_REFERENCE_NUM, INSTALL_BILL_DATE, INVOICE_CHARGES, INVOICE_CREDITS, GL_ACCT_ORG_CODE, CAMPAIGN_CODE, AMOUNT)
END
go
...
BEGIN
  ...
  INCLUDE (INVOICE_REFERENCE_NUM, INVOICE_LINE_NUM, FISCAL_PERIOD, CHECK_NUMBER, AMOUNT, TRANS_NUMBER, PRODUCT_CODE, ST_ID)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Trans]') AND [name] = N'iTransTRANS_NUMBER')
BEGIN
  CREATE NONCLUSTERED INDEX iTransTRANS_NUMBER ON [dbo].[Trans] (TRANS_NUMBER, LINE_NUMBER, SUB_LINE_NUMBER)
  INCLUDE (TRANSACTION_TYPE, POSTED, SOURCE_SYSTEM, OWNER_ORG_CODE, JOURNAL_TYPE, INVOICE_REFERENCE_NUM, AMOUNT)
END
go
...
BEGIN
  ...
  INCLUDE (PRODUCT_CODE, OWNER_ORG_CODE, TRANSACTION_DATE, TRANSACTION_TYPE, ACTIVITY_SEQN, AMOUNT, IS_FR_ITEM, JOURNAL_TYPE, INVOICE_REFERENCE_NUM, INVOICE_LINE_NUM, BT_ID, EFFECTIVE_DATE, FISCAL_PERIOD)
END
go
...
BEGIN
  ...
  INCLUDE (SOURCE_SYSTEM, TRANSACTION_TYPE, INVOICE_LINE_NUM, INVOICE_CHARGES, INVOICE_CREDITS, INVOICE_REFERENCE_NUM, JOURNAL_TYPE)
END
go
...
BEGIN
  ...
  INCLUDE (ACTIVITY_SEQN, INVOICE_REFERENCE_NUM, IS_FR_ITEM)
END
go
...
BEGIN
  ...
  INCLUDE (IS_MATCH_GIFT, INVOICE_REFERENCE_NUM, INVOICE_LINE_NUM, FISCAL_PERIOD, CHECK_NUMBER, MEM_TRIB_ID, MEM_TRIB_NAME_TEXT, MATCH_GIFT_TRANS_NUM, PRODUCT_CODE, ACTIVITY_SEQN)
END
go
...
BEGIN
  ...
  INCLUDE (TRANSACTION_DATE, TRANS_NUMBER, TAXABLE_VALUE, TRANSACTION_TYPE, ST_ID, PRODUCT_CODE, RECEIPT_ID, OWNER_ORG_CODE, JOURNAL_TYPE, INVOICE_LINE_NUM, INVOICE_REFERENCE_NUM, BT_ID, CHECK_NUMBER, AMOUNT, FISCAL_PERIOD, GL_ACCT_ORG_CODE)
END
go
...
BEGIN
  ...
  INCLUDE (CHECK_NUMBER, AMOUNT, FISCAL_PERIOD, JOURNAL_TYPE, INVOICE_LINE_NUM, IS_FR_ITEM, INVOICE_REFERENCE_NUM, TRANS_NUMBER, TRANSACTION_DATE, TRANSACTION_TYPE, ACTIVITY_SEQN, SOURCE_SYSTEM)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[UserDefinedTableStorage]') AND [name] = N'PK_UserDefinedTableStorage')
BEGIN
