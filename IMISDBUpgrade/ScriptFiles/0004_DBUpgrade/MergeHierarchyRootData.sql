...
IF EXISTS (SELECT 1 FROM HierarchyRoot WHERE RootHierarchyKey = 'b21b2362-c3d4-4441-8140-b40a5b36bfb5')
BEGIN
    UPDATE HierarchyRoot SET HierarchyRootName = '~', HierarchyRootDescription = 'Member R', OrganizationKey = '00000000-0000-0000-0000-000000000000', AccessKey = '00000000-0000-0000-ca00-000000000e1f', UniformType = 'NavigationItem', CreatedOn = '20131220 11:52:59', CreatedByUserKey = 'c6a5b257-7284-4bf1-9773-3a1e5b63829e', UpdatedOn = '20131220 11:52:59', UpdatedByUserKey = 'c6a5b257-7284-4bf1-9773-3a1e5b63829e', MarkedForDeleteOn = NULL
    WHERE RootHierarchyKey = 'b21b2362-c3d4-4441-8140-b40a5b36bfb5'
END
ELSE
BEGIN
    INSERT INTO HierarchyRoot (RootHierarchyKey, HierarchyRootName, HierarchyRootDescription, OrganizationKey, AccessKey, UniformType, CreatedOn, CreatedByUserKey, UpdatedOn, UpdatedByUserKey, MarkedForDeleteOn)
    VALUES ('b21b2362-c3d4-4441-8140-b40a5b36bfb5', '~', 'Member R', '00000000-0000-0000-0000-000000000000', '00000000-0000-0000-ca00-000000000e1f', 'NavigationItem', '20131220 11:52:59', 'c6a5b257-7284-4bf1-9773-3a1e5b63829e', '20131220 11:52:59', 'c6a5b257-7284-4bf1-9773-3a1e5b63829e', NULL)
END
GO
