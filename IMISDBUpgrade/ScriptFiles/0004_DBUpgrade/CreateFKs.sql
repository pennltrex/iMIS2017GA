...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'PublishQueue' AND [CONSTRAINT_NAME] = 'FK_PublishQueue_PublishServerRef')
    ALTER TABLE [dbo].[PublishQueue] WITH CHECK ADD CONSTRAINT [FK_PublishQueue_PublishServerRef]
    FOREIGN KEY (PublishServerCode) REFERENCES [PublishServerRef] (PublishServerCode)
go
ALTER TABLE [dbo].[PublishQueue] CHECK CONSTRAINT [FK_PublishQueue_PublishServerRef]
go
