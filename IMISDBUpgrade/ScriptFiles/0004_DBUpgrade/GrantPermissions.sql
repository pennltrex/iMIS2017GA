...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'P ' and name = 'asi_GetVatCountryForTaxByLocation')
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'P ' and name = 'asi_LoginTokenCleanup')
    GRANT EXECUTE ON [asi_LoginTokenCleanup] TO [IMIS]
go

IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'P ' and name = 'asi_LoginTokenCreate')
    GRANT EXECUTE ON [asi_LoginTokenCreate] TO [IMIS]
go

IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'P ' and name = 'asi_LoginTokenValidate')
    GRANT EXECUTE ON [asi_LoginTokenValidate] TO [IMIS]
go

IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'P ' and name = 'asi_UpdateFundraisingViewTables_DUES')
    GRANT EXECUTE ON [asi_UpdateFundraisingViewTables_DUES] TO [IMIS]
go

IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'P ' and name = 'asi_UpdateFundraisingViewTables_FR')
    GRANT EXECUTE ON [asi_UpdateFundraisingViewTables_FR] TO [IMIS]
go

IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'P ' and name = 'asi_UpdateFundraisingViewTables_MEET')
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'GatewayTransaction')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [GatewayTransaction] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'LoginToken')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [LoginToken] TO [IMIS]
go
...
IF EXISTS (SELECT 1 FROM sysobjects WHERE type = 'U ' and name = 'TaxCategory')
    GRANT REFERENCES, SELECT, INSERT, DELETE, UPDATE ON [TaxCategory] TO [IMIS]
go
