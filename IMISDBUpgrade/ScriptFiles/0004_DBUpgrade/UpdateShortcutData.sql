...
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('c7cd384d-4bb3-49a1-a36a-082740764bba', '/OrganizationAccount', '@/iSamples/MemberR/Contact_Management/Organization_Profile', '60b993c6-6608-4d34-89e6-e8cfe0234e3e', '9a52c25b-f9a5-4e8d-adac-0690fe049413', 'Used for displaying the account page of an organization which the user can edit.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/OrganizationAccount', URL = '@/iSamples/MemberR/Contact_Management/Organization_Profile', WebsiteDocumentVersionKey = '60b993c6-6608-4d34-89e6-e8cfe0234e3e', TargetDocumentVersionKey = '9a52c25b-f9a5-4e8d-adac-0690fe049413', URLMappingDesc = 'Used for displaying the account page of an organization which the user can edit.', URLParameters = '', URLMappingTypeCode = 30
...
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('04ff3146-7b15-4159-9317-187f1eb4aa2f', '/StaffCommunityLanding', '@/iCore/Staff_Dashboards/Contacts_Dashboard', NULL, '61a1bac3-ea70-444f-8b0f-cf94dc0aca01', 'Landing page for the Community area of the Staff site.', '', 20)
END
...
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('5062f290-dc05-4acf-9fba-35e6d098f3ef', '/MyAccount', '@/iSamples/MemberR/Contact_Management/My_Account', '60b993c6-6608-4d34-89e6-e8cfe0234e3e', '58804187-d91f-4a0c-a8f7-0546984d26d3', 'Used for displaying the member''s account page for the donor site', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/MyAccount', URL = '@/iSamples/MemberR/Contact_Management/My_Account', WebsiteDocumentVersionKey = '60b993c6-6608-4d34-89e6-e8cfe0234e3e', TargetDocumentVersionKey = '58804187-d91f-4a0c-a8f7-0546984d26d3', URLMappingDesc = 'Used for displaying the member''s account page for the donor site', URLParameters = '', URLMappingTypeCode = 30
...
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('af929345-187a-45de-a5d7-8cfa79dab3f4', '/FullAccount', '@/iSamples/MemberR/Contact_Management/My_Account', '60b993c6-6608-4d34-89e6-e8cfe0234e3e', '58804187-d91f-4a0c-a8f7-0546984d26d3', 'Used for displaying a staff view of a user account page.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/FullAccount', URL = '@/iSamples/MemberR/Contact_Management/My_Account', WebsiteDocumentVersionKey = '60b993c6-6608-4d34-89e6-e8cfe0234e3e', TargetDocumentVersionKey = '58804187-d91f-4a0c-a8f7-0546984d26d3', URLMappingDesc = 'Used for displaying a staff view of a user account page.', URLParameters = '', URLMappingTypeCode = 30
