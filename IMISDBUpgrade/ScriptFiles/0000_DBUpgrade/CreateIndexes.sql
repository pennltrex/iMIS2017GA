...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CorrespondenceDistributionLetterTemplateTypeRef]') AND [name] = N'PK_CorrespondenceDistributionLetterTemplateTypeRef')
BEGIN
  ALTER TABLE [dbo].[CorrespondenceDistributionLetterTemplateTypeRef]
  ADD CONSTRAINT PK_CorrespondenceDistributionLetterTemplateTypeRef PRIMARY KEY CLUSTERED (CorrespondenceDistributionKey, LetterTemplateTypeDocumentTypeCode)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CorrespondenceDistributionRef]') AND [name] = N'PK_CorrespondenceDistributionRef')
BEGIN
  ALTER TABLE [dbo].[CorrespondenceDistributionRef]
  ADD CONSTRAINT PK_CorrespondenceDistributionRef PRIMARY KEY CLUSTERED (CorrespondenceDistributionKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CorrespondenceDistributionRef]') AND [name] = N'AK_CorrespondenceDistributionRef_CorrespondenceDistributionDesc')
BEGIN
  ALTER TABLE [dbo].[CorrespondenceDistributionRef]
  ADD CONSTRAINT AK_CorrespondenceDistributionRef_CorrespondenceDistributionDesc UNIQUE NONCLUSTERED (CorrespondenceDistributionDesc)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CorrespondenceSender]') AND [name] = N'PK_CorrespondenceSender')
BEGIN
  ALTER TABLE [dbo].[CorrespondenceSender]
  ADD CONSTRAINT PK_CorrespondenceSender PRIMARY KEY CLUSTERED (CorrespondenceSenderKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CorrespondenceSender]') AND [name] = N'IX_CorrespondenceSender_ContactKey')
BEGIN
  CREATE NONCLUSTERED INDEX IX_CorrespondenceSender_ContactKey ON [dbo].[CorrespondenceSender] (ContactKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CorrespondenceSender]') AND [name] = N'AK_CorrespondenceSender_ContactKey')
BEGIN
  ALTER TABLE [dbo].[CorrespondenceSender]
  ADD CONSTRAINT AK_CorrespondenceSender_ContactKey UNIQUE NONCLUSTERED (ContactKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CorrespondenceSenderStatusRef]') AND [name] = N'PK_CorrespondenceSenderStatusRef')
BEGIN
  ALTER TABLE [dbo].[CorrespondenceSenderStatusRef]
  ADD CONSTRAINT PK_CorrespondenceSenderStatusRef PRIMARY KEY CLUSTERED (CorrespondenceSenderStatusCode)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CorrespondenceSenderStatusRef]') AND [name] = N'IX_CorrespondenceSenderStatusRef')
BEGIN
  CREATE UNIQUE NONCLUSTERED INDEX IX_CorrespondenceSenderStatusRef ON [dbo].[CorrespondenceSenderStatusRef] (CorrespondenceSenderStatusName)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[CorrespondenceSignature]') AND [name] = N'PK_CorrespondenceSignature')
BEGIN
  ALTER TABLE [dbo].[CorrespondenceSignature]
  ADD CONSTRAINT PK_CorrespondenceSignature PRIMARY KEY CLUSTERED (CorrespondenceSignatureKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[EmailAccountRef]') AND [name] = N'PK_EmailAccountRef')
BEGIN
  ALTER TABLE [dbo].[EmailAccountRef]
  ADD CONSTRAINT PK_EmailAccountRef PRIMARY KEY CLUSTERED (EmailAccountKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[EmailAccountRef]') AND [name] = N'AK_EmailAccountRef_EmailAccountDesc')
BEGIN
  ALTER TABLE [dbo].[EmailAccountRef]
  ADD CONSTRAINT AK_EmailAccountRef_EmailAccountDesc UNIQUE NONCLUSTERED (EmailAccountDesc)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[FaxAccountRef]') AND [name] = N'PK_FaxAccountRef')
BEGIN
  ALTER TABLE [dbo].[FaxAccountRef]
  ADD CONSTRAINT PK_FaxAccountRef PRIMARY KEY CLUSTERED (FaxAccountKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[FaxAccountRef]') AND [name] = N'AK_FaxAccoutnRef_FaxAccountDesc')
BEGIN
  ALTER TABLE [dbo].[FaxAccountRef]
  ADD CONSTRAINT AK_FaxAccoutnRef_FaxAccountDesc UNIQUE NONCLUSTERED (FaxAccountDesc)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[GroupLogicalDefinition]') AND [name] = N'PK_GroupLogicalDefinition')
BEGIN
  ALTER TABLE [dbo].[GroupLogicalDefinition]
  ADD CONSTRAINT PK_GroupLogicalDefinition PRIMARY KEY CLUSTERED (GroupLogicalDefinitionKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[GroupRoleToolAccess]') AND [name] = N'PK_GroupRoleToolAccess')
BEGIN
  ALTER TABLE [dbo].[GroupRoleToolAccess]
  ADD CONSTRAINT PK_GroupRoleToolAccess PRIMARY KEY CLUSTERED (GroupTypeKey, GroupRoleKey, GroupToolKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[GroupToolRef]') AND [name] = N'PK_GroupToolRef')
BEGIN
  ALTER TABLE [dbo].[GroupToolRef]
  ADD CONSTRAINT PK_GroupToolRef PRIMARY KEY CLUSTERED (GroupToolKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[GroupToolRef]') AND [name] = N'AK_GroupToolRef_GroupToolDesc')
BEGIN
  ALTER TABLE [dbo].[GroupToolRef]
  ADD CONSTRAINT AK_GroupToolRef_GroupToolDesc UNIQUE NONCLUSTERED (GroupToolDesc)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[GroupTypeAllowedTool]') AND [name] = N'PK_GroupTypeAllowedTool')
BEGIN
  ALTER TABLE [dbo].[GroupTypeAllowedTool]
  ADD CONSTRAINT PK_GroupTypeAllowedTool PRIMARY KEY CLUSTERED (GroupTypeKey, GroupToolKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[GroupTypeAllowedType]') AND [name] = N'PK_GroupTypeAllowedType')
BEGIN
  ALTER TABLE [dbo].[GroupTypeAllowedType]
  ADD CONSTRAINT PK_GroupTypeAllowedType PRIMARY KEY CLUSTERED (GroupTypeKey, UniformType)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[InboundCommunicationLog]') AND [name] = N'PK_InboundCommunicationLog')
BEGIN
  ALTER TABLE [dbo].[InboundCommunicationLog]
  ADD CONSTRAINT PK_InboundCommunicationLog PRIMARY KEY CLUSTERED (InboundCommunicationLogKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[LetterheadRef]') AND [name] = N'PK_LetterheadRef')
BEGIN
  ALTER TABLE [dbo].[LetterheadRef]
  ADD CONSTRAINT PK_LetterheadRef PRIMARY KEY CLUSTERED (LetterheadKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[LetterheadRef]') AND [name] = N'AK_LetterheadRef_LetterheadDesc')
BEGIN
  ALTER TABLE [dbo].[LetterheadRef]
  ADD CONSTRAINT AK_LetterheadRef_LetterheadDesc UNIQUE NONCLUSTERED (LetterheadDesc)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[LetterTemplateTypeDocumentTypeRef]') AND [name] = N'PK_LetterTemplateTypeDocumentTypeRef')
BEGIN
  ALTER TABLE [dbo].[LetterTemplateTypeDocumentTypeRef]
  ADD CONSTRAINT PK_LetterTemplateTypeDocumentTypeRef PRIMARY KEY CLUSTERED (LetterTemplateTypeDocumentTypeCode, DocumentTypeCode)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[LetterTemplateTypeRef]') AND [name] = N'PK_LetterTemplateTypeRef')
BEGIN
  ALTER TABLE [dbo].[LetterTemplateTypeRef]
  ADD CONSTRAINT PK_LetterTemplateTypeRef PRIMARY KEY CLUSTERED (DocumentTypeCode)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[MonitoredEmailAccountRef]') AND [name] = N'PK_MonitoredEmailAccountRef')
BEGIN
  ALTER TABLE [dbo].[MonitoredEmailAccountRef]
  ADD CONSTRAINT PK_MonitoredEmailAccountRef PRIMARY KEY CLUSTERED (MonitoredEmailAccountKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[MonitoredEmailAccountRef]') AND [name] = N'AK_MonitoredEmailAccountRef_MonitoredEmailAccountName')
BEGIN
  ALTER TABLE [dbo].[MonitoredEmailAccountRef]
  ADD CONSTRAINT AK_MonitoredEmailAccountRef_MonitoredEmailAccountName UNIQUE NONCLUSTERED (MonitoredEmailAccountName)
END
go
...
BEGIN
  CREATE CLUSTERED INDEX iName_IndexesINDEX_NAME ON [dbo].[Name_Indexes] (INDEX_NAME, INDEX_VALUE)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Name_Lookup]') AND [name] = N'pkName_LookupID')
BEGIN
  ALTER TABLE [dbo].[Name_Lookup]
  ADD CONSTRAINT pkName_LookupID PRIMARY KEY CLUSTERED (ID, SEQN)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Name_TabTest]') AND [name] = N'pkName_TabTestID')
BEGIN
  ALTER TABLE [dbo].[Name_TabTest]
  ADD CONSTRAINT pkName_TabTestID PRIMARY KEY CLUSTERED (ID, SEQN)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[Name_Volunteer]') AND [name] = N'PK_Name_Volunteer')
BEGIN
  ALTER TABLE [dbo].[Name_Volunteer]
  ADD CONSTRAINT PK_Name_Volunteer PRIMARY KEY CLUSTERED (ID, SEQN)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[OutboundCommunicationLog]') AND [name] = N'PK_OutboundCommunicationLog')
BEGIN
  ALTER TABLE [dbo].[OutboundCommunicationLog]
  ADD CONSTRAINT PK_OutboundCommunicationLog PRIMARY KEY CLUSTERED (OutboundCommunicationLogKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[OutboundCommunicationStatusReasonRef]') AND [name] = N'PK_OutboundCommunicationStatusReasonRef')
BEGIN
  ALTER TABLE [dbo].[OutboundCommunicationStatusReasonRef]
  ADD CONSTRAINT PK_OutboundCommunicationStatusReasonRef PRIMARY KEY CLUSTERED (OutboundCommunicationStatusReasonKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[OutboundLetterTemplateLog]') AND [name] = N'PK_OutboundLetterTemplateLog')
BEGIN
  ALTER TABLE [dbo].[OutboundLetterTemplateLog]
  ADD CONSTRAINT PK_OutboundLetterTemplateLog PRIMARY KEY CLUSTERED (OutboundLetterTemplateLogKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PackageLog]') AND [name] = N'PK_PackageLog')
BEGIN
  ALTER TABLE [dbo].[PackageLog]
  ADD CONSTRAINT PK_PackageLog PRIMARY KEY CLUSTERED (PackageLogKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PackageLog]') AND [name] = N'IX_PackageLog')
BEGIN
  CREATE NONCLUSTERED INDEX IX_PackageLog ON [dbo].[PackageLog] (PackageLogKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PackageLogPackageQueue]') AND [name] = N'PK_PackageLogPackageQueue')
BEGIN
  ALTER TABLE [dbo].[PackageLogPackageQueue]
  ADD CONSTRAINT PK_PackageLogPackageQueue PRIMARY KEY CLUSTERED (PackageLogKey, PackageQueueKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PaperSourceRef]') AND [name] = N'PK_PaperSourceRef')
BEGIN
  ALTER TABLE [dbo].[PaperSourceRef]
  ADD CONSTRAINT PK_PaperSourceRef PRIMARY KEY CLUSTERED (PaperSourceKey)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PrinterRef]') AND [name] = N'PK_PrinterRef')
BEGIN
  ALTER TABLE [dbo].[PrinterRef]
  ADD CONSTRAINT PK_PrinterRef PRIMARY KEY CLUSTERED (PrinterKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[PrinterRef]') AND [name] = N'AK_PrinterRef_PrinterDesc')
BEGIN
  ALTER TABLE [dbo].[PrinterRef]
  ADD CONSTRAINT AK_PrinterRef_PrinterDesc UNIQUE NONCLUSTERED (PrinterDesc)
END
go
...
IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[WebPartGalleryEntryRef]') AND [name] = N'PK_WebPartGalleryEntryRef')
BEGIN
  ALTER TABLE [dbo].[WebPartGalleryEntryRef]
  ADD CONSTRAINT PK_WebPartGalleryEntryRef PRIMARY KEY CLUSTERED (WebPartGalleryEntryKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[WebPartGalleryLicense]') AND [name] = N'PK_WebPartGalleryLicense')
BEGIN
  ALTER TABLE [dbo].[WebPartGalleryLicense]
  ADD CONSTRAINT PK_WebPartGalleryLicense PRIMARY KEY CLUSTERED (WebPartGalleryKey, LicenseKey)
END
go

IF NOT EXISTS (SELECT * FROM sysindexes WHERE [id] = OBJECT_ID(N'[dbo].[WebPartGalleryRef]') AND [name] = N'PK_WebPartGalleryRef')
BEGIN
  ALTER TABLE [dbo].[WebPartGalleryRef]
  ADD CONSTRAINT PK_WebPartGalleryRef PRIMARY KEY CLUSTERED (WebPartGalleryKey)
END
go
