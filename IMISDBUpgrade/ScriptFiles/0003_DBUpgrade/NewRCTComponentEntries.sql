...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Discussion Forum List')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Address Mapper')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'General Product Display')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Discussion Forum Configuration')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Content Html')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Social Share')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Change History Display')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Cart Checkout Button Link')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Payment Method Set Creator')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Tribute Gift Editor')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Discussion Forum List Item')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Discussion Forum Home')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Quick Links')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'NRDS Sync Buttons')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Display Name Editor')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Promotion Creator')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Content Tagged List')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Related Items')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Promotion Manager')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Function Edit')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Communication Creator')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Embedded Web Page')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Dynamic Content Collection Organizer')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Advanced Search')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Content File')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Social Profile List Creator')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'NRDS Configuration')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Batch Invoice Payment Processing')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Content Reference')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'EFT Batch Status')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Content Link')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Event Calendar')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Content Page Break')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Item Creator')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Recurring Donation Creator')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Recurring Donation Pledge Creator')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Contact Sign In')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Event Edit')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'EFT Gateway Account Administrator')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'NRDS Sync By ID')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Report Display')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Data Showcase')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Progress Tracker')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Administrative Console')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
    VALUES ('b63ee63b-a28d-4327-96dd-f927bcbbef4a','Administrative Console','Access the Administrative Console via a remote desktop connection.','IAtom','Asi.Web.iParts.Common.AdminConsole.AdminConsoleCommon','Asi.Web.iParts.Common.AdminConsole',NULL,NULL,1,0,NULL,'~/iParts/Common/AdminConsole/AdminConsoleConfigEdit.ascx','~/iParts/Common/AdminConsole/AdminConsoleConfigEdit.ascx','~/iParts/Common/AdminConsole/AdminConsoleDisplay.ascx',NULL)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Auto Pay Instructions Creator')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Recent History')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [InterfaceName] = 'IAtom' AND [Name] = 'Open Invoice List Display')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
