...
UPDATE SystemConfig SET ParameterValue = '25'
...
UPDATE SystemConfig SET ParameterValue = '3071'
...
GO
UPDATE [System_Params] SET [ShortValue] = '20.2.25.3071' where ParameterName = 'System_Control.Version'
GO
