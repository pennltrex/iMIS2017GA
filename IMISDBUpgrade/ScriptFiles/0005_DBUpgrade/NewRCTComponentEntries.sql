...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [ComponentKey] = 'a1175f96-5daf-4525-95d0-317ee1450841')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
    VALUES ('a1175f96-5daf-4525-95d0-317ee1450841','Slideshow','Image slideshow','IAtom','Asi.Web.iParts.Common.Slideshow.SlideshowCommon','Asi.Web.iParts.Common.Slideshow',NULL,NULL,1,0,NULL,'~/iparts/Common/Slideshow/SlideshowConfigEdit.ascx','~/iparts/Common/Slideshow/SlideshowConfigEdit.ascx','~/iparts/Common/Slideshow/SlideshowDisplay.ascx',NULL)
END
...
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
    VALUES ('377f845f-7fbf-424a-b06f-3dbf2fd7a710','Tasks Log','ASI INTERNAL ONLY. It allows you view automated tasks logs.','IAtom','Asi.Web.iParts.Common.Tasks.TasksLogCommon','Asi.Web.iParts.Common.Tasks',NULL,NULL,1,0,NULL,'~/iParts/Common/Tasks/TasksLogConfigEdit.ascx','~/iParts/Common/Tasks/TasksLogConfigEdit.ascx','~/iParts/Common/Tasks/TasksLogDisplay.ascx',NULL)
END
...
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
    VALUES ('ce367dca-d0c9-40c6-8e7d-5a8321d9b711','Potential Duplicate List Display','ASI INTERNAL ONLY. List potential duplicate contacts that can be merged or marked as not duplicates','IAtom','Asi.Web.iParts.ContactManagement.PotentialDuplicateListDisplay.PotentialDuplicateListDisplayCommon','Asi.Web.iParts.ContactManagement.PotentialDuplicateListDisplay',NULL,NULL,1,0,NULL,'~/iparts/Contact Management/PotentialDuplicateListDisplay/PotentialDuplicateListDisplayConfigEdit.ascx','~/iparts/Contact Management/PotentialDuplicateListDisplay/PotentialDuplicateListDisplayConfigEdit.ascx','~/iparts/Contact Management/PotentialDuplicateListDisplay/PotentialDuplicateListDisplayDisplay.ascx',NULL)
END
...
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
    VALUES ('83e7b102-2708-419a-8683-87b89ff4faec','Template Manager','ASI INTERNAL ONLY. It allows you to define templates.','IAtom','Asi.Web.iParts.Common.TemplateManager.TemplateManagerCommon','Asi.Web.iParts.Common.TemplateManager',NULL,NULL,1,0,NULL,'~/iParts/Common/TemplateManager/TemplateManagerConfigEdit.ascx','~/iParts/Common/TemplateManager/TemplateManagerConfigEdit.ascx','~/iParts/Common/TemplateManager/TemplateManagerDisplay.ascx',NULL)
END
...
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
    VALUES ('7ecee69d-baae-4218-8729-8ad281f60ef4','Licensing','iPart that allows ASI Accounting to assign or edit customer licenses.','IAtom','Asi.Web.iParts.LicenseManagement.Licensing.LicensingCommon','Asi.Web.iParts.LicenseManagement.Licensing',NULL,NULL,1,0,NULL,'~/iParts/LicenseManagement/Licensing/LicensingConfigEdit.ascx','~/iParts/LicenseManagement/Licensing/LicensingConfigEdit.ascx','~/iParts/LicenseManagement/Licensing/LicensingDisplay.ascx',NULL)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[ComponentRegistry] WHERE [ComponentKey] = 'a286b16b-8bbf-4355-a826-f3ac79af9bd9')
BEGIN
    INSERT INTO [dbo].[ComponentRegistry] ([ComponentKey], [Name], [Description], [InterfaceName], [TypeName], [AssemblyName], 
                                                 [ConfigureWebUserControl], [ConfigureWindowsControl], [IsTyped], [IsBusinessItem], [ComponentSummaryContentKey],
                                                 [ComponentNewLink], [ComponentEditLink], [ComponentExecuteLink], [DeploymentPackageCode])
    VALUES ('a286b16b-8bbf-4355-a826-f3ac79af9bd9','Slideshow','Image slideshow','IAtom','Asi.Web.iParts.Common.Slideshow.SlideshowCommon','Asi.Web.iParts.Common.Slideshow',NULL,NULL,1,0,NULL,'~/iparts/Common/Slideshow/SlideshowConfigEdit.ascx','~/iparts/Common/Slideshow/SlideshowConfigEdit.ascx','~/iparts/Common/Slideshow/SlideshowDisplay.ascx',NULL)
END
