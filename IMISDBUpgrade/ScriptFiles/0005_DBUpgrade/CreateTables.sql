...
CREATE TABLE [dbo].[ContactCommunicationReasonPreferences] (
    ...
    [OptInFlag] bit NULL,
    [CreatedByUserKey] uniqueidentifier NOT NULL,
    [CreatedOn] datetime NOT NULL CONSTRAINT [DF_ContactCommunicationReasonPreferences_CreatedOn] DEFAULT (getdate()),
    [UpdatedByUserKey] uniqueidentifier NOT NULL,
    [UpdatedOn] datetime NOT NULL CONSTRAINT [DF_ContactCommunicationReasonPreferences_UpdatedOn] DEFAULT (getdate())
)
...
IF NOT EXISTS (SELECT * FROM [sys].[objects] WHERE [object_id] = OBJECT_ID(N'[dbo].[Template]') AND OBJECTPROPERTY([object_id], N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[Template] (
    [TemplateKey] uniqueidentifier NOT NULL,
    [TemplateTypeCode] int NULL,
    [TemplateName] nvarchar(50) NULL,
    [TemplateDesc] nvarchar(200) NULL,
    [IsSystem] bit NOT NULL,
...
IF NOT EXISTS (SELECT * FROM [sys].[objects] WHERE [object_id] = OBJECT_ID(N'[dbo].[TemplateTypeRef]') AND OBJECTPROPERTY([object_id], N'IsUserTable') = 1)
BEGIN
CREATE TABLE [dbo].[TemplateTypeRef] (
