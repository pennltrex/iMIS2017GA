...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'AutoPayAccount' AND [CONSTRAINT_NAME] = 'FK_AutoPayAccount_UserMain')
    ALTER TABLE [dbo].[AutoPayAccount] WITH CHECK ADD CONSTRAINT [FK_AutoPayAccount_UserMain]
    FOREIGN KEY (CreatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[AutoPayAccount] CHECK CONSTRAINT [FK_AutoPayAccount_UserMain]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'AutoPayAccount' AND [CONSTRAINT_NAME] = 'FK_AutoPayAccount_UserMain2')
    ALTER TABLE [dbo].[AutoPayAccount] WITH CHECK ADD CONSTRAINT [FK_AutoPayAccount_UserMain2]
    FOREIGN KEY (UpdatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[AutoPayAccount] CHECK CONSTRAINT [FK_AutoPayAccount_UserMain2]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'AutoPayInstruction' AND [CONSTRAINT_NAME] = 'FK_AutoPayInstruction_AutoPayAccount')
    ALTER TABLE [dbo].[AutoPayInstruction] WITH CHECK ADD CONSTRAINT [FK_AutoPayInstruction_AutoPayAccount]
    FOREIGN KEY (AutoPayAccountKey) REFERENCES [AutoPayAccount] (AutoPayAccountKey)
go
ALTER TABLE [dbo].[AutoPayInstruction] CHECK CONSTRAINT [FK_AutoPayInstruction_AutoPayAccount]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'BillingLogItem' AND [CONSTRAINT_NAME] = 'FK_BillingLogItem_BillingLog')
    ALTER TABLE [dbo].[BillingLogItem] WITH CHECK ADD CONSTRAINT [FK_BillingLogItem_BillingLog]
    FOREIGN KEY (BillingLogKey) REFERENCES [BillingLog] (BillingLogKey)
go
ALTER TABLE [dbo].[BillingLogItem] CHECK CONSTRAINT [FK_BillingLogItem_BillingLog]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'CalculatedEngagementScore' AND [CONSTRAINT_NAME] = 'FK_CalculatedEngagementScore_ContactMain')
    ALTER TABLE [dbo].[CalculatedEngagementScore] WITH CHECK ADD CONSTRAINT [FK_CalculatedEngagementScore_ContactMain]
    FOREIGN KEY (ContactKey) REFERENCES [ContactMain] (ContactKey)
go
ALTER TABLE [dbo].[CalculatedEngagementScore] CHECK CONSTRAINT [FK_CalculatedEngagementScore_ContactMain]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'CalculatedEngagementScore' AND [CONSTRAINT_NAME] = 'FK_CalculatedEngagementScore_EngagementScore')
    ALTER TABLE [dbo].[CalculatedEngagementScore] WITH CHECK ADD CONSTRAINT [FK_CalculatedEngagementScore_EngagementScore]
    FOREIGN KEY (EngagementScoreKey) REFERENCES [EngagementScore] (EngagementScoreKey)
go
ALTER TABLE [dbo].[CalculatedEngagementScore] CHECK CONSTRAINT [FK_CalculatedEngagementScore_EngagementScore]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'CalculatedEngagementScore' AND [CONSTRAINT_NAME] = 'FK_CalculatedEngagementScore_ScoreComponent')
    ALTER TABLE [dbo].[CalculatedEngagementScore] WITH CHECK ADD CONSTRAINT [FK_CalculatedEngagementScore_ScoreComponent]
    FOREIGN KEY (ScoreComponentKey) REFERENCES [ScoreComponent] (ScoreComponentKey)
go
ALTER TABLE [dbo].[CalculatedEngagementScore] CHECK CONSTRAINT [FK_CalculatedEngagementScore_ScoreComponent]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'CommunicationLog' AND [CONSTRAINT_NAME] = 'FK_CommunicationLog_UserMain_UpdatedBy')
    ALTER TABLE [dbo].[CommunicationLog] WITH CHECK ADD CONSTRAINT [FK_CommunicationLog_UserMain_UpdatedBy]
    FOREIGN KEY (UpdatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[CommunicationLog] CHECK CONSTRAINT [FK_CommunicationLog_UserMain_UpdatedBy]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'CommunicationLogRecipientAttachment' AND [CONSTRAINT_NAME] = 'FK_CommunicationLogRecipientAttachment_UserMain_CreatedBy')
    ALTER TABLE [dbo].[CommunicationLogRecipientAttachment] WITH CHECK ADD CONSTRAINT [FK_CommunicationLogRecipientAttachment_UserMain_CreatedBy]
    FOREIGN KEY (CreatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[CommunicationLogRecipientAttachment] CHECK CONSTRAINT [FK_CommunicationLogRecipientAttachment_UserMain_CreatedBy]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'CommunicationLogRecipientAttachment' AND [CONSTRAINT_NAME] = 'FK_CommunicationLogRecipientAttachment_UserMain_UpdatedBy')
    ALTER TABLE [dbo].[CommunicationLogRecipientAttachment] WITH CHECK ADD CONSTRAINT [FK_CommunicationLogRecipientAttachment_UserMain_UpdatedBy]
    FOREIGN KEY (UpdatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[CommunicationLogRecipientAttachment] CHECK CONSTRAINT [FK_CommunicationLogRecipientAttachment_UserMain_UpdatedBy]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'CreditInvoiceExport' AND [CONSTRAINT_NAME] = 'FK_CreditInvoiceExport_UserMain_CreatedBy')
    ALTER TABLE [dbo].[CreditInvoiceExport] WITH CHECK ADD CONSTRAINT [FK_CreditInvoiceExport_UserMain_CreatedBy]
    FOREIGN KEY (CreatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[CreditInvoiceExport] CHECK CONSTRAINT [FK_CreditInvoiceExport_UserMain_CreatedBy]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'CreditInvoiceExportItem' AND [CONSTRAINT_NAME] = 'FK_CreditInvoiceExportItem_CreditInvoiceExport')
    ALTER TABLE [dbo].[CreditInvoiceExportItem] WITH CHECK ADD CONSTRAINT [FK_CreditInvoiceExportItem_CreditInvoiceExport]
    FOREIGN KEY (CreditInvoiceExportKey) REFERENCES [CreditInvoiceExport] (CreditInvoiceExportKey)
go
ALTER TABLE [dbo].[CreditInvoiceExportItem] CHECK CONSTRAINT [FK_CreditInvoiceExportItem_CreditInvoiceExport]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'EngagementCategory' AND [CONSTRAINT_NAME] = 'FK_EngagementCategory_EngagementScore')
    ALTER TABLE [dbo].[EngagementCategory] WITH CHECK ADD CONSTRAINT [FK_EngagementCategory_EngagementScore]
    FOREIGN KEY (EngagementScoreKey) REFERENCES [EngagementScore] (EngagementScoreKey)
go
ALTER TABLE [dbo].[EngagementCategory] CHECK CONSTRAINT [FK_EngagementCategory_EngagementScore]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'EngagementCategory' AND [CONSTRAINT_NAME] = 'FK_EngagementCategory_UserMain_CreatedBy')
    ALTER TABLE [dbo].[EngagementCategory] WITH CHECK ADD CONSTRAINT [FK_EngagementCategory_UserMain_CreatedBy]
    FOREIGN KEY (CreatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[EngagementCategory] CHECK CONSTRAINT [FK_EngagementCategory_UserMain_CreatedBy]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'EngagementCategory' AND [CONSTRAINT_NAME] = 'FK_EngagementCategory_UserMain_UpdatedBy')
    ALTER TABLE [dbo].[EngagementCategory] WITH CHECK ADD CONSTRAINT [FK_EngagementCategory_UserMain_UpdatedBy]
    FOREIGN KEY (UpdatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[EngagementCategory] CHECK CONSTRAINT [FK_EngagementCategory_UserMain_UpdatedBy]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'EngagementCategoryContact' AND [CONSTRAINT_NAME] = 'FK_EngagementCategoryContact_Contact')
    ALTER TABLE [dbo].[EngagementCategoryContact] WITH CHECK ADD CONSTRAINT [FK_EngagementCategoryContact_Contact]
    FOREIGN KEY (ContactKey) REFERENCES [ContactMain] (ContactKey)
go
ALTER TABLE [dbo].[EngagementCategoryContact] CHECK CONSTRAINT [FK_EngagementCategoryContact_Contact]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'EngagementCategoryContact' AND [CONSTRAINT_NAME] = 'FK_EngagementCategoryContact_EngagementCategory')
    ALTER TABLE [dbo].[EngagementCategoryContact] WITH CHECK ADD CONSTRAINT [FK_EngagementCategoryContact_EngagementCategory]
    FOREIGN KEY (EngagementCategoryKey) REFERENCES [EngagementCategory] (EngagementCategoryKey)
go
ALTER TABLE [dbo].[EngagementCategoryContact] CHECK CONSTRAINT [FK_EngagementCategoryContact_EngagementCategory]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'EngagementCategoryContact' AND [CONSTRAINT_NAME] = 'FK_EngagementCategoryContact_EngagementScore')
    ALTER TABLE [dbo].[EngagementCategoryContact] WITH CHECK ADD CONSTRAINT [FK_EngagementCategoryContact_EngagementScore]
    FOREIGN KEY (EngagementScoreKey) REFERENCES [EngagementScore] (EngagementScoreKey)
go
ALTER TABLE [dbo].[EngagementCategoryContact] CHECK CONSTRAINT [FK_EngagementCategoryContact_EngagementScore]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'EngagementPercentile' AND [CONSTRAINT_NAME] = 'FK_EngagementPercentile_EngagementScore')
    ALTER TABLE [dbo].[EngagementPercentile] WITH CHECK ADD CONSTRAINT [FK_EngagementPercentile_EngagementScore]
    FOREIGN KEY (EngagementScoreKey) REFERENCES [EngagementScore] (EngagementScoreKey)
go
ALTER TABLE [dbo].[EngagementPercentile] CHECK CONSTRAINT [FK_EngagementPercentile_EngagementScore]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'EngagementScore' AND [CONSTRAINT_NAME] = 'FK_EngagementScore_SystemTypeRef')
    ALTER TABLE [dbo].[EngagementScore] WITH CHECK ADD CONSTRAINT [FK_EngagementScore_SystemTypeRef]
    FOREIGN KEY (SystemTypeCode) REFERENCES [SystemTypeRef] (SystemTypeCode)
go
ALTER TABLE [dbo].[EngagementScore] CHECK CONSTRAINT [FK_EngagementScore_SystemTypeRef]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'ExpiredMemberUpdateDetailLog' AND [CONSTRAINT_NAME] = 'FK_ExpiredMemberUpdateLog_RunNumber')
    ALTER TABLE [dbo].[ExpiredMemberUpdateDetailLog] WITH CHECK ADD CONSTRAINT [FK_ExpiredMemberUpdateLog_RunNumber]
    FOREIGN KEY (RunNumber) REFERENCES [ExpiredMemberUpdateLog] (RunNumber)
go
ALTER TABLE [dbo].[ExpiredMemberUpdateDetailLog] CHECK CONSTRAINT [FK_ExpiredMemberUpdateLog_RunNumber]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'GLExportDeferredIncomeItem' AND [CONSTRAINT_NAME] = 'FK_GLExportDeferredIncomeItem_GLExport')
    ALTER TABLE [dbo].[GLExportDeferredIncomeItem] WITH CHECK ADD CONSTRAINT [FK_GLExportDeferredIncomeItem_GLExport]
    FOREIGN KEY (GLExportKey) REFERENCES [GLExport] (GLExportKey)
go
ALTER TABLE [dbo].[GLExportDeferredIncomeItem] CHECK CONSTRAINT [FK_GLExportDeferredIncomeItem_GLExport]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'GroupPriceSheet' AND [CONSTRAINT_NAME] = 'FK_GroupPriceSheet_PriceSheet')
    ALTER TABLE [dbo].[GroupPriceSheet] WITH CHECK ADD CONSTRAINT [FK_GroupPriceSheet_PriceSheet]
    FOREIGN KEY (PriceSheetKey) REFERENCES [PriceSheet] (PriceSheetKey)
go
ALTER TABLE [dbo].[GroupPriceSheet] CHECK CONSTRAINT [FK_GroupPriceSheet_PriceSheet]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'GroupUpdateInstruction' AND [CONSTRAINT_NAME] = 'FK_GroupUpdateInstruction_UserMain_CreatedBy')
    ALTER TABLE [dbo].[GroupUpdateInstruction] WITH CHECK ADD CONSTRAINT [FK_GroupUpdateInstruction_UserMain_CreatedBy]
    FOREIGN KEY (CreatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[GroupUpdateInstruction] CHECK CONSTRAINT [FK_GroupUpdateInstruction_UserMain_CreatedBy]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'GroupUpdateInstruction' AND [CONSTRAINT_NAME] = 'FK_GroupUpdateInstruction_UserMain_UpdatedBy')
    ALTER TABLE [dbo].[GroupUpdateInstruction] WITH CHECK ADD CONSTRAINT [FK_GroupUpdateInstruction_UserMain_UpdatedBy]
    FOREIGN KEY (UpdatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[GroupUpdateInstruction] CHECK CONSTRAINT [FK_GroupUpdateInstruction_UserMain_UpdatedBy]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'ImportBatch' AND [CONSTRAINT_NAME] = 'FK_ImportBatch_ImportBatchStatusRef')
    ALTER TABLE [dbo].[ImportBatch] WITH CHECK ADD CONSTRAINT [FK_ImportBatch_ImportBatchStatusRef]
    FOREIGN KEY (ImportBatchStatusCode) REFERENCES [ImportBatchStatusRef] (ImportBatchStatusCode)
go
ALTER TABLE [dbo].[ImportBatch] CHECK CONSTRAINT [FK_ImportBatch_ImportBatchStatusRef]
go

IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'ImportBatch' AND [CONSTRAINT_NAME] = 'FK_ImportBatch_UserMain')
    ALTER TABLE [dbo].[ImportBatch] WITH CHECK ADD CONSTRAINT [FK_ImportBatch_UserMain]
    FOREIGN KEY (CreatedByUserKey) REFERENCES [UserMain] (UserKey)
go
ALTER TABLE [dbo].[ImportBatch] CHECK CONSTRAINT [FK_ImportBatch_UserMain]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'OrgControlImages' AND [CONSTRAINT_NAME] = 'FK_OrgControlImages_DocumentStorageKey')
    ALTER TABLE [dbo].[OrgControlImages] WITH CHECK ADD CONSTRAINT [FK_OrgControlImages_DocumentStorageKey]
    FOREIGN KEY (DocumentStorageKey) REFERENCES [DocumentStorage] (DocumentStorageKey)
go
ALTER TABLE [dbo].[OrgControlImages] CHECK CONSTRAINT [FK_OrgControlImages_DocumentStorageKey]
go
...
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.CONSTRAINT_TABLE_USAGE WHERE [TABLE_NAME] = 'VolunteerAvailability' AND [CONSTRAINT_NAME] = 'FK_VolunteerAvailability_DayOfTheWeekRef')
    ALTER TABLE [dbo].[VolunteerAvailability] WITH CHECK ADD CONSTRAINT [FK_VolunteerAvailability_DayOfTheWeekRef]
    FOREIGN KEY (DayOfTheWeekCode) REFERENCES [DayOfTheWeekRef] (DayOfTheWeekCode)
go
ALTER TABLE [dbo].[VolunteerAvailability] CHECK CONSTRAINT [FK_VolunteerAvailability_DayOfTheWeekRef]
go
