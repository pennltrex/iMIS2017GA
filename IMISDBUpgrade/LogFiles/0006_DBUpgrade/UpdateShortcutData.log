...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '3c525ab4-975f-4ddc-8ca8-06bad4abe482')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('3c525ab4-975f-4ddc-8ca8-06bad4abe482', '/JoinNow', '@/iCore/Membership/Join_Billing_Cycles', '4243d9e2-e91e-468c-97c2-2046d70c1e1a', 'b71d4ccd-de1c-4ca1-b345-e2f41916ca6e', 'Used for membership join in the staff site.', '', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '193fd6bd-6574-499d-8f1f-11b473c1ba29')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('193fd6bd-6574-499d-8f1f-11b473c1ba29', '/CommitteeDetailAdmin', '@/iCore/Groups/Committee_Detail_Admin', '60b993c6-6608-4d34-89e6-e8cfe0234e3e', '5aa2d488-3d14-43a2-9fa0-1df31b471153', 'Used to display committee group details for users authorized to administer the group.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/CommitteeDetailAdmin', URL = '@/iCore/Groups/Committee_Detail_Admin', WebsiteDocumentVersionKey = '60b993c6-6608-4d34-89e6-e8cfe0234e3e', TargetDocumentVersionKey = '5aa2d488-3d14-43a2-9fa0-1df31b471153', URLMappingDesc = 'Used to display committee group details for users authorized to administer the group.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '193fd6bd-6574-499d-8f1f-11b473c1ba29'
END

IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '086155fa-b69e-45d4-9bd0-11c6f3d2548c')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('086155fa-b69e-45d4-9bd0-11c6f3d2548c', '/CommitteeDetailAdmin', '@/iCore/Groups/Committee_Detail_Admin', 'e7590042-1672-4d0f-a20c-335e0bf62de2', '5aa2d488-3d14-43a2-9fa0-1df31b471153', 'Used to display committee group details for users authorized to administer the group.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/CommitteeDetailAdmin', URL = '@/iCore/Groups/Committee_Detail_Admin', WebsiteDocumentVersionKey = 'e7590042-1672-4d0f-a20c-335e0bf62de2', TargetDocumentVersionKey = '5aa2d488-3d14-43a2-9fa0-1df31b471153', URLMappingDesc = 'Used to display committee group details for users authorized to administer the group.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '086155fa-b69e-45d4-9bd0-11c6f3d2548c'
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = 'fa1d593f-fa73-4333-9b5b-122f32a8b759')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('fa1d593f-fa73-4333-9b5b-122f32a8b759', '/ActivityProfile', '@/iCore/Contacts/ContactLayouts/Activity_Profile', NULL, 'a5395dd6-e9a4-4999-bf8f-4843b2cb2b49', 'Used to display specific activity panels for a contact.', '', 20)
END
...
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('5de0f2fb-de4b-4f43-aaf0-15978b128d26', '/OrganizationJoin', '@/iCore/Membership/Organization_Join', 'e7590042-1672-4d0f-a20c-335e0bf62de2', '4050b11e-b1fe-4fe2-ba90-f5c61e3b6e00', 'Used for displaying the organization join as a member page.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/OrganizationJoin', URL = '@/iCore/Membership/Organization_Join', WebsiteDocumentVersionKey = 'e7590042-1672-4d0f-a20c-335e0bf62de2', TargetDocumentVersionKey = '4050b11e-b1fe-4fe2-ba90-f5c61e3b6e00', URLMappingDesc = 'Used for displaying the organization join as a member page.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '5de0f2fb-de4b-4f43-aaf0-15978b128d26'
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '8c8582cd-cae8-4d95-b61b-271fa74f6adc')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('8c8582cd-cae8-4d95-b61b-271fa74f6adc', '/AutoPayMembershipDashboard', '@/iCore/Staff_Dashboards/AutoPay/Membership/AutoPay_Membership_Dashboard', NULL, 'c544e92c-68d8-46c6-a3e9-8eceacf54fd4', 'Used to display the AutoPay Membership dashboard.', '', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = 'a0d68620-e9ba-4f2c-84b1-32964e4bd2fd')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('a0d68620-e9ba-4f2c-84b1-32964e4bd2fd', '/CommitteeDetailAdmin', '@/iCore/Groups/Committee_Detail_Admin', NULL, '5aa2d488-3d14-43a2-9fa0-1df31b471153', 'Used to display committee group details for users authorized to administer the group.', '', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '8bac8c3d-48fd-44bc-bc85-3986b5cd74c6')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('8bac8c3d-48fd-44bc-bc85-3986b5cd74c6', '/CommitteeDetailAdmin', '@/iCore/Groups/Committee_Detail_Admin', 'deea0907-2d5e-405c-8ec4-e9794203eadd', '5aa2d488-3d14-43a2-9fa0-1df31b471153', 'Used to display committee group details for users authorized to administer the group.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/CommitteeDetailAdmin', URL = '@/iCore/Groups/Committee_Detail_Admin', WebsiteDocumentVersionKey = 'deea0907-2d5e-405c-8ec4-e9794203eadd', TargetDocumentVersionKey = '5aa2d488-3d14-43a2-9fa0-1df31b471153', URLMappingDesc = 'Used to display committee group details for users authorized to administer the group.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '8bac8c3d-48fd-44bc-bc85-3986b5cd74c6'
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = 'e6b649f7-d059-42b4-a3fd-42a3fe3ec32d')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('e6b649f7-d059-42b4-a3fd-42a3fe3ec32d', '/UpdateAttendance', '@/iCore/Events/Manage/Update_Attendance', NULL, '1242ae5a-57aa-4c8c-97ad-d1e18f703c87', 'Used to display the update attendance page', '', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = 'fd9065b6-5d0c-4008-884f-461a15a470e5')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('fd9065b6-5d0c-4008-884f-461a15a470e5', '/StaffEngagementLanding', '@/iCore/Staff_Dashboards/Engagement/Engagement_dashboard', NULL, '547433b0-5eba-42a7-8936-5d6339b64e99', 'Landing page for the Engagement area of the Staff site.', 'EngagementScoreId=d0292457-7eff-42e1-b655-be8715b78552', 20)
END
...
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/OrganizationJoinNow', URL = '@/iCore/Membership/General_product_display_without_cart_button', WebsiteDocumentVersionKey = 'e7590042-1672-4d0f-a20c-335e0bf62de2', TargetDocumentVersionKey = '339e3091-e79c-4c82-bdde-76203bae43db', URLMappingDesc = 'Used for displaying the product for organization membership fees.', URLParameters = 'iProductCode=COMPANY_REGULAR_MEMBERSHIP', URLMappingTypeCode = 30
...
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/OrganizationJoinNow', URL = '@/iCore/Membership/General_product_display_without_cart_button', WebsiteDocumentVersionKey = 'deea0907-2d5e-405c-8ec4-e9794203eadd', TargetDocumentVersionKey = '339e3091-e79c-4c82-bdde-76203bae43db', URLMappingDesc = 'Used for displaying the product for organization membership fees.', URLParameters = 'iProductCode=COMPANY_REGULAR_MEMBERSHIP', URLMappingTypeCode = 30
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = 'e32fab19-bc51-486d-a7d6-58451528945d')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('e32fab19-bc51-486d-a7d6-58451528945d', '/EventInvoiceReport', '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', 'e7590042-1672-4d0f-a20c-335e0bf62de2', 'e18bc153-a295-4984-bd73-f8f4ab20d603', 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/EventInvoiceReport', URL = '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', WebsiteDocumentVersionKey = 'e7590042-1672-4d0f-a20c-335e0bf62de2', TargetDocumentVersionKey = 'e18bc153-a295-4984-bd73-f8f4ab20d603', URLMappingDesc = 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = 'e32fab19-bc51-486d-a7d6-58451528945d'
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '1183f52e-da2c-4f79-8dc2-59808977e9dc')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('1183f52e-da2c-4f79-8dc2-59808977e9dc', '/EventInvoiceReport', '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', 'a9ef00fe-f87f-42a6-8150-3f3775861973', 'e18bc153-a295-4984-bd73-f8f4ab20d603', 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/EventInvoiceReport', URL = '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', WebsiteDocumentVersionKey = 'a9ef00fe-f87f-42a6-8150-3f3775861973', TargetDocumentVersionKey = 'e18bc153-a295-4984-bd73-f8f4ab20d603', URLMappingDesc = 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '1183f52e-da2c-4f79-8dc2-59808977e9dc'
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = 'd14ed605-bfea-4489-a846-677740354d28')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('d14ed605-bfea-4489-a846-677740354d28', '/AutoPayFundraisingDashboard', '@/iCore/Staff_Dashboards/AutoPay/Fundraising/Autopay_fundraising_dashboard', NULL, 'bc8b4491-0c67-4a3d-9254-c7f0c72b0fb2', 'Used to display the AutoPay Fundraising dashboard.', '', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '1f1258ea-4abc-477c-a702-6c0c1cf23f36')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('1f1258ea-4abc-477c-a702-6c0c1cf23f36', '/EventInvoiceReport', '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', '60b993c6-6608-4d34-89e6-e8cfe0234e3e', 'e18bc153-a295-4984-bd73-f8f4ab20d603', 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/EventInvoiceReport', URL = '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', WebsiteDocumentVersionKey = '60b993c6-6608-4d34-89e6-e8cfe0234e3e', TargetDocumentVersionKey = 'e18bc153-a295-4984-bd73-f8f4ab20d603', URLMappingDesc = 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '1f1258ea-4abc-477c-a702-6c0c1cf23f36'
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '84a8a0c4-133e-48f4-ab9c-7821e846c447')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('84a8a0c4-133e-48f4-ab9c-7821e846c447', '/EventInvoiceReport', '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', '77c6bf57-1505-456c-a3e9-8473532388ea', 'e18bc153-a295-4984-bd73-f8f4ab20d603', 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/EventInvoiceReport', URL = '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', WebsiteDocumentVersionKey = '77c6bf57-1505-456c-a3e9-8473532388ea', TargetDocumentVersionKey = 'e18bc153-a295-4984-bd73-f8f4ab20d603', URLMappingDesc = 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '84a8a0c4-133e-48f4-ab9c-7821e846c447'
END
...
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('b8119e25-13b7-451d-8614-825cd4624af7', '/CommitteeDetail', '@/iCore/Groups/Committee_Detail', NULL, '402f1086-6a8e-4ec7-8b2c-9272087f18e7', 'Used to display committee group details.', '', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = 'cdeaca9d-2bd9-4059-a47d-9297af804054')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('cdeaca9d-2bd9-4059-a47d-9297af804054', '/StaffOrgEngagement', '@/iCore/Staff_Dashboards/Engagement/Organization/Engagement_dashboard', NULL, '6543b0e0-fa15-4482-829b-d5393c30b51e', 'Engagement dashboard for organization engagement.', 'EngagementScoreId=73c94168-8893-4d25-bfca-78ef4dbdee60', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '28a0b24d-58e0-415e-94c8-9e90b2cbfc50')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('28a0b24d-58e0-415e-94c8-9e90b2cbfc50', '/EventRegistrationDetail', '@/iCore/Events/Registrations/Event_registration', NULL, '048d2749-0490-4c3a-b62b-a7bd67fd68e2', 'Used to display the details of a contact''s event registration.', '', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '5a3c354f-c023-4111-8dd3-a9422c4f5173')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('5a3c354f-c023-4111-8dd3-a9422c4f5173', '/StaffVolunteersLanding', '@/iCore/Staff_Dashboards/Volunteers/Volunteers_dashboard', NULL, '3895ee92-10a1-4e6d-b798-983006cb02e7', 'Landing page for the Volunteers area of the Staff site.', '', 20)
END
...
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('58a4cb09-c2b6-4e79-9a14-aa9635192ef9', '/EventDashboard', '@/iCore/Staff_Dashboards/Specific_Event/Event_Dashboard', 'e7590042-1672-4d0f-a20c-335e0bf62de2', 'a8ab6743-9dda-41f7-9aa2-7a681a203082', 'Used for displaying an event for staff users.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/EventDashboard', URL = '@/iCore/Staff_Dashboards/Specific_Event/Event_Dashboard', WebsiteDocumentVersionKey = 'e7590042-1672-4d0f-a20c-335e0bf62de2', TargetDocumentVersionKey = 'a8ab6743-9dda-41f7-9aa2-7a681a203082', URLMappingDesc = 'Used for displaying an event for staff users.', URLParameters = '', URLMappingTypeCode = 30
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '13f4b4ef-f8e2-4f1b-933f-b0d9755be911')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('13f4b4ef-f8e2-4f1b-933f-b0d9755be911', '/EventInvoiceReport', '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', 'a39d90dd-afae-4f98-85e3-ef34feaf63cc', 'e18bc153-a295-4984-bd73-f8f4ab20d603', 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/EventInvoiceReport', URL = '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', WebsiteDocumentVersionKey = 'a39d90dd-afae-4f98-85e3-ef34feaf63cc', TargetDocumentVersionKey = 'e18bc153-a295-4984-bd73-f8f4ab20d603', URLMappingDesc = 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '13f4b4ef-f8e2-4f1b-933f-b0d9755be911'
END
...
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('70553431-2bb3-4946-9c16-b5a59a02a6e5', '/OrganizationJoin', '@/iCore/Membership/Organization_Join', 'deea0907-2d5e-405c-8ec4-e9794203eadd', '4050b11e-b1fe-4fe2-ba90-f5c61e3b6e00', 'Used for displaying the organization join as a member page.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/OrganizationJoin', URL = '@/iCore/Membership/Organization_Join', WebsiteDocumentVersionKey = 'deea0907-2d5e-405c-8ec4-e9794203eadd', TargetDocumentVersionKey = '4050b11e-b1fe-4fe2-ba90-f5c61e3b6e00', URLMappingDesc = 'Used for displaying the organization join as a member page.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '70553431-2bb3-4946-9c16-b5a59a02a6e5'
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '4e61aa1a-402e-4d2e-ba42-d86b3bde6d50')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('4e61aa1a-402e-4d2e-ba42-d86b3bde6d50', '/CommitteeDetailAdmin', '@/iCore/Groups/Committee_Detail_Admin', 'a9ef00fe-f87f-42a6-8150-3f3775861973', '5aa2d488-3d14-43a2-9fa0-1df31b471153', 'Used to display committee group details for users authorized to administer the group.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/CommitteeDetailAdmin', URL = '@/iCore/Groups/Committee_Detail_Admin', WebsiteDocumentVersionKey = 'a9ef00fe-f87f-42a6-8150-3f3775861973', TargetDocumentVersionKey = '5aa2d488-3d14-43a2-9fa0-1df31b471153', URLMappingDesc = 'Used to display committee group details for users authorized to administer the group.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = '4e61aa1a-402e-4d2e-ba42-d86b3bde6d50'
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = 'c121d587-ac4f-405c-9f44-de8283688e5d')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('c121d587-ac4f-405c-9f44-de8283688e5d', '/StaffMovesManagementLanding', '@/iCore/Staff_Dashboards/Moves_management/OverallMovesManagement', NULL, '8751c1a0-71cd-4837-85e0-8e515f400938', 'Used to display the Moves Management dashboard.', '', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = '39753a9b-6794-4ba0-a372-e788cd171571')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('39753a9b-6794-4ba0-a372-e788cd171571', '/EventInvoiceReport', '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', NULL, 'e18bc153-a295-4984-bd73-f8f4ab20d603', 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', '', 20)
END
...
IF NOT EXISTS (SELECT 1 FROM [dbo].[URLMapping] WHERE URLMappingKey = 'bcf8b632-9e42-4bae-b635-f6e7d1f9759b')
BEGIN
    INSERT INTO [dbo].[URLMapping] (URLMappingKey, DirectoryName, URL, WebsiteDocumentVersionKey, TargetDocumentVersionKey, URLMappingDesc, URLParameters, URLMappingTypeCode)
    VALUES ('bcf8b632-9e42-4bae-b635-f6e7d1f9759b', '/EventInvoiceReport', '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', 'deea0907-2d5e-405c-8ec4-e9794203eadd', 'e18bc153-a295-4984-bd73-f8f4ab20d603', 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', '', 30)
END
ELSE
BEGIN
    UPDATE [dbo].[URLMapping] SET DirectoryName = '/EventInvoiceReport', URL = '@/iCore/Staff_Dashboards/Specific_Event/Event_invoice_report', WebsiteDocumentVersionKey = 'deea0907-2d5e-405c-8ec4-e9794203eadd', TargetDocumentVersionKey = 'e18bc153-a295-4984-bd73-f8f4ab20d603', URLMappingDesc = 'Used by the Event invoice report alert (the Print Invoice button in an event registration) to display an event invoice report.', URLParameters = '', URLMappingTypeCode = 30
    WHERE URLMappingKey = 'bcf8b632-9e42-4bae-b635-f6e7d1f9759b'
END
